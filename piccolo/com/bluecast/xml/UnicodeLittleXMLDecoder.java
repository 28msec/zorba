/*
 * $Id: UnicodeLittleXMLDecoder.java,v 1.5 2004/07/11 09:37:37 yuvalo Exp $
 *
...
final public class UnicodeLittleXMLDecoder
    ...
    public void decode (byte[] in_buf, int in_off, int in_len, char[] out_buf,
        ...
        for (i = o = 0; i + 1 < in_len && o < out_len; i += 2) {
            char c = (char)(((0xFF & in_buf[in_off + i + 1]) << 8) | (0xFF & in_buf[
                    in_off + i]));
