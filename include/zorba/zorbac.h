...
/**
  * Sets the SMTP server in the given static context.
  *
  * \param context The XQC_StaticContext that this function pointer is a member of
  * \param SMTP_server The SMTP server to set in the given context.
  *
  * \retval ::XQC_NO_ERROR
  * \retval ::XQC_INTERNAL_ERROR
  */
...
/**
  * Returns the SMTP server that is set in the given static context.
  * The returned SMTP server is only valid as long as the corresponding static context
  * is valid.
  *
  * \param context The XQC_StaticContext that this function pointer is a member of
  * \param[out] SMTP_server The SMTP server that is set in the given context.
  *
  * \retval ::XQC_NO_ERROR
  * \retval ::XQC_INTERNAL_ERROR
 */
...
/**
  * Sets the SMTP username in the given static context.
  *
  * \param context The XQC_StaticContext that this function pointer is a member of
  * \param SMTP_uname The SMTP username to set in the given context.
  *
  * \retval ::XQC_NO_ERROR
  * \retval ::XQC_INTERNAL_ERROR
 */
...
/**
  * Returns the SMTP username that is set in the given static context.
  * The returned SMTP username is only valid as long as the corresponding static context
  * is valid.
  *
  * \param context The XQC_StaticContext that this function pointer is a member of
  * \param[out] SMTP_uname The SMTP username that is set in the given context.
  *
  * \retval ::XQC_NO_ERROR
  * \retval ::XQC_INTERNAL_ERROR
 */
...
/**
  * Sets the SMTP user password in the given static context.
  *
  * \param context The XQC_StaticContext that this function pointer is a member of
  * \param SMTP_upwd The SMTP user password to set in the given context.
  *
  * \retval ::XQC_NO_ERROR
  * \retval ::XQC_INTERNAL_ERROR
 */
...
/**
  * Returns the SMTP user password that is set in the given static context.
  * The returned SMTP user password is only valid as long as the corresponding static context
  * is valid.
  *
  * \param context The XQC_StaticContext that this function pointer is a member of
  * \param[out] SMTP_upwd The SMTP user password that is set in the given context.
  *
  * \retval ::XQC_NO_ERROR
  * \retval ::XQC_INTERNAL_ERROR
 */
