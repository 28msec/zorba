...
/**
 * An "error" constant to indicate "no error."
 */
...
ZORBA_DEC_ERROR( API0019_MODULE_ALREADY_REGISTERED );
...
ZORBA_DEC_ERROR( API0039_XQUERY_HAS_ITERATOR_ALREADY );
ZORBA_DEC_ERROR( API0040_ITERATOR_IS_NOT_OPEN );
ZORBA_DEC_ERROR( API0041_ITERATOR_IS_ALREADY_OPEN );
ZORBA_DEC_ERROR( API0042_ITERATOR_IS_CLOSED );
...
ZORBA_DEC_ERROR( STR0055_STREAMABLE_STRING_CONSUMED );
