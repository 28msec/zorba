...
ZORBA_DEC_ERROR( ZXQP0002_DYNAMIC_ITERATOR_OVERRUN );
ZORBA_DEC_ERROR( ZXQP0003_DYNAMIC_ILLEGAL_NODE_CHILD );
ZORBA_DEC_ERROR( ZXQP0004_DYNAMIC_TARGET_NAMESPACE_NOT_FOUND );
ZORBA_DEC_ERROR( ZXQP0005_SYSTEM_NOT_SUPPORTED );
ZORBA_DEC_ERROR( ZXQP0006_SYSTEM_ASSERT_FAILED );
ZORBA_DEC_ERROR( ZXQP0007_SYSTEM_HASH_ERROR_KEYLEN_EXCEEDS_MAXKEYLEN );
ZORBA_DEC_ERROR( ZXQP0008_SYSTEM_VECTOR_OUT_OF_RANGE );
ZORBA_DEC_ERROR( ZXQP0009_SYSTEM_READ_LOCK_FAILED );
ZORBA_DEC_ERROR( ZXQP0010_SYSTEM_WRITE_LOCK_FAILED );
ZORBA_DEC_ERROR( ZXQP0011_SYSTEM_POP_FROM_EMPTY_LIST );
ZORBA_DEC_ERROR( ZXQP0012_SYSTEM_FILE_ERROR_IN_FUNCTION );
ZORBA_DEC_ERROR( ZXQP0013_SYSTEM_FXCHARHEAP_IOEXCEPTION );
ZORBA_DEC_ERROR( ZXQP0015_SYSTEM_NOT_YET_IMPLEMENTED );
...
ZORBA_DEC_ERROR( ZXQP0022_GET_RESULTS_AS_DOM_FAILED );
ZORBA_DEC_ERROR( ZXQP0023_GET_RESULTS_AS_SAX_FAILED );
ZORBA_DEC_ERROR( ZXQP0024_XML_DOES_NOT_MATCH_SCHEMA );
ZORBA_DEC_ERROR( ZXQP0025_COULD_NOT_CREATE_ITEM );
ZORBA_DEC_ERROR( ZXQP0026_COULD_NOT_CREATE_THREAD );
ZORBA_DEC_ERROR( ZXQP0026_CANNOT_INIT_STORE );
...
ZORBA_DEC_ERROR( ZXQP0034_ILLEGAL_UTF8_BYTE );
ZORBA_DEC_ERROR( ZXQP0035_ILLEGAL_UTF16_BYTE );
...
ZORBA_DEC_ERROR( ZXQD0000_PREFIX_NOT_DECLARED );
ZORBA_DEC_ERROR( ZXQD0001_DOCUMENT_NOT_VALID );
...
ZORBA_DEC_ERROR( ZDDY0002_COLLECTION_EXISTS_ALREADY );
...
ZORBA_DEC_ERROR( ZDDY0022_INDEX_EXISTS_ALREADY );
...
ZORBA_DEC_ERROR( ZDST0025_INDEX_PROPERTIES_CONFLICT );
...
ZORBA_DEC_ERROR( ZDST0042_MULTI_VALUED_IC_KEY );
ZORBA_DEC_ERROR( ZDST0043_NON_ATOMIC_IC_KEY );
ZORBA_DEC_ERROR( ZDST0044_IC_DECL_IN_MAIN_MODULE );
ZORBA_DEC_ERROR( ZDST0045_IC_HAS_FREE_VARS );
ZORBA_DEC_ERROR( ZDST0046_IC_HAS_INVALID_DATA_SOURCE );
ZORBA_DEC_ERROR( ZDST0047_IC_NOT_DETERMINISTIC );
