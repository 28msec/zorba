...
ZORBA_DEC_ERROR( ZAPI0061_CONV_JSON_SERIALIZE );
ZORBA_DEC_ERROR( ZAPI0062_CONV_JSON_PARAM );
ZORBA_DEC_ERROR( ZAPI0064_CONV_JSON_ML_SERIALIZE );
ZORBA_DEC_ERROR( ZAPI0065_CONV_JSON_ML_PARAM );
ZORBA_DEC_ERROR( ZAPI0066_JSON_SEQUENCE_CANNOT_BE_SERIALIZED );
