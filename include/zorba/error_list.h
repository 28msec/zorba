...
ZORBA_DEC_ERROR( ZXQP0029_URI_ACCESS_DENIED );
...
ZORBA_DEC_ERROR( ZXQP0037_INAPPROPRIATE_MODULE_VERSION );
ZORBA_DEC_ERROR( ZXQP0038_INAPPROPRIATE_ZORBA_VERSION );
ZORBA_DEC_ERROR( ZXQP0039_INVALID_VERSION_SPECIFICATION );

ZORBA_DEC_ERROR( ZXQP0040_MISSING_NONDETERMINISTIC_ANNOTATION );
...
ZORBA_DEC_ERROR( ZDDY0029_INDEX_POINT_GENERAL_PROBE_NOT_ALLOWED );
ZORBA_DEC_ERROR( ZDDY0030_INDEX_RANGE_GENERAL_PROBE_NOT_ALLOWED );
...
ZORBA_DEC_ERROR( ZGDB0001_CANNOT_CONNECT_TO_CLIENT );
