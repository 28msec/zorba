...
namespace xqp {
  ...
  class xqpString
  {
    public:
      ...
      int
      compare(xqpString src) const;

      /**
       *Compare 2 strings based on a specific collation URI
       */
      int
      compare(xqpString src, xqpString collationUri) const;
       ...
       */
      int32_t
      indexOf(xqpString pattern) const;
       ...
       */
      int32_t
      indexOf(xqpString pattern, xqpString collationUri) const;
       ...
       */
      int32_t
      lastIndexOf(xqpString pattern) const;
       ...
       */
      int32_t
      lastIndexOf(xqpString pattern, xqpString collationUri) const;

      /**Determine if this ends with the characters in pattern in the range [0, length).
       *  @param pattern The text to search for.
       */
      bool
      endsWith(xqpString pattern) const;
       ...
       */
      bool
      endsWith(xqpString pattern, xqpString collationUri) const;
