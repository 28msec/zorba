...
public:
  ...
  public:
    ...
    */
    ...
    const xqpStringStore* getStore() const { return theStrStore.getp(); }
    xqpStringStore* getStore() { return theStrStore.getp(); }
#endif
    xqpStringStore* getStore() const { return theStrStore.getp(); }
