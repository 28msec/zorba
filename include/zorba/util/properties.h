#ifndef XQP_PROPERTIES_H
#define XQP_PROPERTIES_H
...
namespace xqp {
  class Properties {
    private:
       ...
       */
      bool loadProps(int argc, char *argv[], bool aNoCmdLineOptions = false);
    public:
      static Properties* instance(bool aCheckLoad = true);
      ...
      // Getters
      const std::string& getQuery() { return theQuery; }
      bool traceParsing() { return theTraceParsing; }
      bool traceScanning() { return theTraceScanning; }
      bool useSerializer() { return theUseSerializer; }
