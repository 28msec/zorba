...
typedef enum
{
  ...
  // character references are not allowed (for example if the character occurs
  ...
  SESU0011,
  // It is an error if the value of the normalization-form parameter specifies
  // a normalization form that is not supported by the serializer.
  ...
  XQP0016_RESERVED_MODULE_TARGET_NAMESPACE,
  XQP0017_FILE_ACCESS_DISABLED,
  XQP0019_INTERNAL_ERROR,
  XQP0020_INVALID_URI,
  XQP0021_USER_ERROR,
  XQP0022_GET_RESULTS_AS_DOM_FAILED,
  XQP0023_GET_RESULTS_AS_SAX_FAILED,
  XQP0024_XML_DOES_NOT_MATCH_SCHEMA,
  ...
  XQP0029_MODULE_IMPORT_NOT_ALLOWED,
  XQP0030_DEADLOCK,
  ...
  SRL0015_INCOMPATIBLE_BETWEEN_32_AND_64_BITS_OR_LE_AND_BE,
  ...
  API0005_XQUERY_ALREADY_EXECUTING,
  API0006_XQUERY_ALREADY_CLOSED,
  API0007_CANNOT_SERIALIZE_PUL,
  API0008_NOT_AN_UPDATE_XQUERY,
  API0009_XQUERY_NOT_COMPILED_IN_DEBUG_MODE,
  API0010_XQUERY_HAS_ITERATOR_ALREADY,

  API0040_ITERATOR_IS_NOT_OPEN,
  API0041_ITERATOR_IS_OPEN_ALREADY,
  API0042_ITERATOR_QUERY_IS_CLOSED,

  API0010_THREAD_NOT_INITIALIZED,
  ...
  STR0040_TYPE_ERROR,
  STR0041_NAN_COMPARISON,
  STR0045_DUPLICATE_NODE_ERROR,
  ...
  XDST0007_COLLECTION_DECL_IN_FOREIGN_MODULE,
  ...
  XDST0036_INDEX_DECL_IN_FOREIGN_MODULE,
  ...
  XDST0048_IC_DECL_IN_FOREIGN_MODULE,
  ...
  XDDY0028_INDEX_DOMAIN_HAS_DUPLICATE_NODES,
  XDDY0029_INDEX_GENERAL_PROBE_NOT_ALLOWED,
