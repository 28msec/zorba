#ifndef XQP_TYPEIDENT_H
#define XQP_TYPEIDENT_H
...
class TypeIdentifier : virtual public rcobject {
  public:
    ...
    quantifier_t get_quantifier() const
    {
      return m_quantifier;
    }
...
class ContentTypeHolder {
  public:
    const type_ident_ref_t get_content_type() const
    {
...
class ElementOrAttributeTypeIdentifier : public TypeIdentifier, public ContentTypeHolder {
  public:
    ...
    const rchandle<xqpStringStore> get_uri() const
    {
      return m_uri;
    }

    const rchandle<xqpStringStore> get_local() const
    {
      return m_local;
    }
  protected:
    ElementOrAttributeTypeIdentifier(quantifier_t quantifier, rchandle<xqpStringStore> uri, rchandle<xqpStringStore> local, type_ident_ref_t content_type)
...
class ElementTypeIdentifier : public ElementOrAttributeTypeIdentifier {
  public:
    ElementTypeIdentifier(quantifier_t quantifier, rchandle<xqpStringStore> uri, rchandle<xqpStringStore> local, type_ident_ref_t content_type)
...
class AttributeTypeIdentifier : public ElementOrAttributeTypeIdentifier {
  public:
    AttributeTypeIdentifier(quantifier_t quantifier, rchandle<xqpStringStore> uri, rchandle<xqpStringStore> local, type_ident_ref_t content_type)
      : ElementOrAttributeTypeIdentifier(quantifier, uri, local, content_type) { }
