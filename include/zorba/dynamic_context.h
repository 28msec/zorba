...
namespace zorba {
  ...
  {
    public:
      // TODO why are they needed (see types....h)
      typedef enum
      {
    ...
    public:
      ...
      virtual bool
      setVariableAsInt( xqp_string varname, xqp_int int_value) = 0;
      ...
      virtual bool
      setVariableAsString( xqp_string varname, xqp_string str_value) = 0;
      ...
      virtual bool
      setContextItemAsDocumentFromFile(xqp_string file_path, xqp_string storeUri = "") = 0;
