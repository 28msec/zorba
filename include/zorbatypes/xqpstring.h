...
namespace zorba {
  ...
  class xqpString
  {
    public:
      ...
      int
      compare(xqpString src, Collator* = 0) const;

      int
      compare(const char* src, Collator* = 0) const;
       ...
       */
      int32_t
      indexOf(xqpString pattern, Collator* = 0) const;
       ...
       */
      int32_t
      lastIndexOf(xqpString pattern, Collator* = 0) const;

      /**Determine if this ends with the characters in pattern in the range [0, length).
       *  @param pattern The text to search for.
       */
      bool
      endsWith(xqpString pattern, Collator* = 0) const;
