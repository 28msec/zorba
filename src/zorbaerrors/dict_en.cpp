...
extern entry const dict_en[] = {
  ...
  { "XUDY0023", "namespace binding conflict" },
  { "XUDY0024", "updates introduce conflicting namespace bindings" },
  ...
  { "XUDY0031", "multiple calls to fn:put() in same snapshot with same URI" },
  ...
  { "XUST0026", "\"$1\": revalidation mode not supported" },
