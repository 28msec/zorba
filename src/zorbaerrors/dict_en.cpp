...
extern entry const dict_en[] = {
  ...
  { "~NoExternalFunction", "external function $2 not available from external modules" },
  { "~NoExternalModuleFromDLL", "external module $2 not available from dynamic library" },
  ...
  { "~format_integer_optional_format_modifier_not_closed", "bad optional format modifier, cannot find closing ')' " },
