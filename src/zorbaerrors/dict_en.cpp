...
extern entry const dict_en[] = {
  ...
  { "~NoSeqForFnOp", "sequence of more than one item can not be operand for function \"$2()\"" },
  ...
  { "~OSFailedError_12", "error $1: $2" },
  { "~OSWhatFailedError_123", "$1 failed (error $2): $3" },
  ...
  { "~OperationNotDef_23", "$2 not defined for \"$3\"" },
  ...
  { "~VarValMustBeSingleItem", "\"$2\": variable value must be single item" },
  { "~Variable", "variable" },
