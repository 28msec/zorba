...
ZORBA_DEF_ERROR( ZAPI0040,ITERATOR_IS_NOT_OPEN );
ZORBA_DEF_ERROR( ZAPI0041,ITERATOR_IS_ALREADY_OPEN );
ZORBA_DEF_ERROR( ZAPI0042,ITERATOR_IS_CLOSED );
ZORBA_DEF_ERROR( ZAPI0051,REST_ERROR_PAYLOAD );
ZORBA_DEF_ERROR( ZAPI0061,CONV_JSON_SERIALIZE );
ZORBA_DEF_ERROR( ZAPI0062,CONV_JSON_PARAM );
ZORBA_DEF_ERROR( ZAPI0064,CONV_JSON_ML_SERIALIZE );
ZORBA_DEF_ERROR( ZAPI0065,CONV_JSON_ML_PARAM );
ZORBA_DEF_ERROR( ZAPI0066,JSON_SEQUENCE_CANNOT_BE_SERIALIZED );
ZORBA_DEF_ERROR( ZAPI0070,INVALID_SERIALIZATION_METHOD_FOR_SAX );

////////// Zorba Class Serialization Errors ///////////////////////////////////

ZORBA_DEF_ERROR( ZCSE0001,INEXISTENT_INPUT_FIELD );
...
ZORBA_DEF_ERROR( ZCSE0005,CLASS_VERSION_IS_TOO_NEW );
ZORBA_DEF_ERROR( ZCSE0006,CLASS_VERSION_IS_TOO_OLD );
...
ZORBA_DEF_ERROR( ZXQP0002,DYNAMIC_ITERATOR_OVERRUN );
ZORBA_DEF_ERROR( ZXQP0003,DYNAMIC_ILLEGAL_NODE_CHILD );
ZORBA_DEF_ERROR( ZXQP0004,DYNAMIC_TARGET_NAMESPACE_NOT_FOUND );
ZORBA_DEF_ERROR( ZXQP0005,SYSTEM_NOT_SUPPORTED );
ZORBA_DEF_ERROR( ZXQP0006,SYSTEM_ASSERT_FAILED );
ZORBA_DEF_ERROR( ZXQP0007,SYSTEM_HASH_ERROR_KEYLEN_EXCEEDS_MAXKEYLEN );
ZORBA_DEF_ERROR( ZXQP0008,SYSTEM_VECTOR_OUT_OF_RANGE );
ZORBA_DEF_ERROR( ZXQP0009,SYSTEM_READ_LOCK_FAILED );
ZORBA_DEF_ERROR( ZXQP0010,SYSTEM_WRITE_LOCK_FAILED );
ZORBA_DEF_ERROR( ZXQP0011,SYSTEM_POP_FROM_EMPTY_LIST );
ZORBA_DEF_ERROR( ZXQP0012,SYSTEM_FILE_ERROR_IN_FUNCTION );
ZORBA_DEF_ERROR( ZXQP0013,SYSTEM_FXCHARHEAP_IOEXCEPTION );
ZORBA_DEF_ERROR( ZXQP0015,SYSTEM_NOT_YET_IMPLEMENTED );
...
ZORBA_DEF_ERROR( ZXQP0022,GET_RESULTS_AS_DOM_FAILED );
ZORBA_DEF_ERROR( ZXQP0023,GET_RESULTS_AS_SAX_FAILED );
ZORBA_DEF_ERROR( ZXQP0024,XML_DOES_NOT_MATCH_SCHEMA );
ZORBA_DEF_ERROR( ZXQP0025,COULD_NOT_CREATE_ITEM );
ZORBA_DEF_ERROR( ZXQP0026,COULD_NOT_CREATE_THREAD );
ZORBA_DEF_ERROR( ZXQP0026,CANNOT_INIT_STORE );
ZORBA_DEF_ERROR( ZXQP0027,MS_DOM_ERROR );
ZORBA_DEF_ERROR( ZXQP0028,FUNCTION_IMPL_NOT_FOUND );
...
ZORBA_DEF_ERROR( ZXQP0034,ILLEGAL_UTF8_BYTE );
ZORBA_DEF_ERROR( ZXQP0035,ILLEGAL_UTF16_BYTE );
...
ZORBA_DEF_ERROR( ZXQD0000,PREFIX_NOT_DECLARED );
ZORBA_DEF_ERROR( ZXQD0001,DOCUMENT_NOT_VALID );
