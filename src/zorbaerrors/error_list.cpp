...
ZORBA_DEF_ERROR( ZDDY0002,COLLECTION_EXISTS_ALREADY );
...
ZORBA_DEF_ERROR( ZDDY0021,INDEX_IS_NOT_DECLARED );
ZORBA_DEF_ERROR( ZDDY0022,INDEX_EXISTS_ALREADY );
...
ZORBA_DEF_ERROR( ZDDY0031,IC_IS_NOT_DECLARED );
ZORBA_DEF_ERROR( ZDDY0032,IC_IS_NOT_ACTIVATED );
...
ZORBA_DEF_ERROR( ZDST0025,INDEX_PROPERTIES_CONFLICT );
...
ZORBA_DEF_ERROR( ZDST0041,IC_IS_ALREADY_DECLARED );
ZORBA_DEF_ERROR( ZDST0042,MULTI_VALUED_IC_KEY );
ZORBA_DEF_ERROR( ZDST0043,NON_ATOMIC_IC_KEY );
ZORBA_DEF_ERROR( ZDST0044,IC_DECL_IN_MAIN_MODULE );
ZORBA_DEF_ERROR( ZDST0045,IC_HAS_FREE_VARS );
ZORBA_DEF_ERROR( ZDST0046,IC_HAS_INVALID_DATA_SOURCE );
ZORBA_DEF_ERROR( ZDST0047,IC_NOT_DETERMINISTIC );
