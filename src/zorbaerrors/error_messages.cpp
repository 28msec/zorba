...
DEF_ERR_CODE (FODF1280, FODF1280, "The decimal format name supplied to fn:format-number() is not a valid QName, or the prefix in the QName is undeclared, or there is no decimal format in the static context with a matching name.")
DEF_ERR_CODE (FODF1310, FODF1310, "The picture string supplied to fn:format-number() has invalid syntax.")
...
DEF_ERR_CODE(STR0041_NAN_COMPARISON, STR0041,
"Comparison with NaN")
...
//
DEF_ERR_CODE (XQD0000_PREFIX_NOT_DECLARED, XQP000, "XQD0000_PREFIX_NOT_DECLARED")

DEF_ERR_CODE (XQD0001_DOCUMENT_NOT_VALID, XQP000, "XQD0000_PREFIX_NOT_DECLARED")
...
DEF_ERR_CODE (XQP0016_RESERVED_MODULE_TARGET_NAMESPACE, XQP0016,
"The target namespace /s is reserved by zorba and cannot be used as the target namespace of any user-level module")
