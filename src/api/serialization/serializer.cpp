...
void
serializer::transcoder::verbatim(const char ch)
{
  os << ch;
}
...
serializer::utf8_to_utf16_transcoder&
serializer::utf8_to_utf16_transcoder::operator<<(const char* str)
{
...
serializer::utf8_to_utf16_transcoder&
serializer::utf8_to_utf16_transcoder::operator<<(const char ch)
{
  int done = 0;
