...
XQuery_t ZorbaEngine::createQuery(
...
ZorbaAlertsManager& ZorbaEngine::getAlertsManagerForCurrentThread()
{
...
void ZorbaEngine::setDefaultCollation(
...
void ZorbaEngine::getDefaultCollation(
    std::string  *coll_string,
    ::Collator::ECollationStrength *coll_strength,
...
void	ZorbaEngine::setItemSerializerParameter(
...
void	ZorbaEngine::setDocSerializerParameter(
    xqp_string parameter_name,
    xqp_string value)
{
	zorba::getZorbaForCurrentThread()->
