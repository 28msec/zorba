...
internal::Stemmer const* static_context::get_stemmer( iso639_1::type lang ) const {
...
void static_context::remove_stemmer_provider( internal::StemmerProvider const *p ) {
  ztd::erase_1st_if(
    theStemmerProviders,
