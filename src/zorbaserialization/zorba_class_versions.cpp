...
SERIALIZABLE_TEMPLATE_INSTANCE_VERSIONS(Batcher, Batcher<FnDebugIterator>)
SERIALIZABLE_TEMPLATE_INSTANCE_VERSIONS(Batcher, Batcher<ZorbaMailIterator>)
...
SERIALIZABLE_TEMPLATE_INSTANCE_VERSIONS(NaryBaseIterator, NaryBaseIterator<FnTraceIterator, FnTraceIteratorState>)
SERIALIZABLE_TEMPLATE_INSTANCE_VERSIONS(NaryBaseIterator, NaryBaseIterator<FnDebugIterator, PlanIteratorState>)
SERIALIZABLE_TEMPLATE_INSTANCE_VERSIONS(NaryBaseIterator, NaryBaseIterator<ZorbaMailIterator, PlanIteratorState>)
SERIALIZABLE_TEMPLATE_INSTANCE_VERSIONS(NaryBaseIterator, NaryBaseIterator<CtxVarAssignIterator, PlanIteratorState>)
