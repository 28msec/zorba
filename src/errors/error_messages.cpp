...
DEF_ERR_CODE (API0001, API0001, "Empty query")
DEF_ERR_CODE (API0002, API0002, "Query compilation failed")
DEF_ERR_CODE (API0003, API0003, "Query not compiled")
DEF_ERR_CODE (API0004, API0004, "Query already compiled")
DEF_ERR_CODE (API0005, API0005, "COLLECTION_ALREADY_EXISTS")
DEF_ERR_CODE (API0006, API0006, "COLLECTION_NOT_FOUND")
DEF_ERR_CODE (API0007, API0007, "COLLECTION_ITEM_MUST_BE_A_NODE")
...
DEF_ERR_CODE (SENR0001_Item_is_attribute_or_namespace_node, SENR0001, "Item is attribute or namespace node")
DEF_ERR_CODE (SEPM0016_Invalid_parameter_value, SEPM0016, "Invalid parameter value")
