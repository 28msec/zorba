...
namespace zorba { namespace error {
  ...
  ZorbaError
  ErrorManager::createException(::zorba::ZorbaError::ErrorCode aErrorCode,
                      const std::string& aFileName, int aLineNumber, const QueryLoc& aLocation)
  {
  ...
  ZorbaError
  ErrorManager::createException(::zorba::ZorbaError::ErrorCode aErrorCode, const xqpString& aDescription,
  ...
  ZorbaError
  ErrorManager::createException(::zorba::ZorbaError::ErrorCode aErrorCode, const std::string& aDesc, 
                                const std::string& aFileName, int aLineNumber)
  {
  ...
  ZorbaUserError
  ErrorManager::createUserException(const xqpString& aErrorURI, const xqpString aErrorLocalName,
  ...
  void
  ErrorManager::addError(::zorba::ZorbaError::ErrorCode aErrorCode, const xqpString& aDescription,
  ...
  void
  ErrorManager::addError(::zorba::ZorbaError::ErrorCode aErrorCode, 
                         const std::string& aParam1, const std::string& aParam2,
                         const std::string& aFileName, int aLineNumber,
                         const QueryLoc& aLocation)
  {
  ...
  void
  ErrorManager::addWarning(ZorbaWarning::WarningCode aWarningCode, const xqpString& aDescription,
                           const QueryLoc& aLocation, const std::string& aFileName, int aLineNumber)
  {
    assert(false);
  }
