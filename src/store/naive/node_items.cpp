...
namespace xqp
{
  ...
  DocumentNodeNaive::DocumentNodeNaive ( const xqp_string& baseURI_arg, const xqp_string& docURI_arg, TempSeq_t& children_arg ) : baseURI ( baseURI_arg ), docURI ( docURI_arg ), children ( children_arg )
  { }
  ...
  Item_t ElementNodeNaive::getNodeName() const
  {
    return this->name;
  }
  ...
  Item_t AttributeNodeNaive::getNodeName() const
  {
    return this->name;
  }
