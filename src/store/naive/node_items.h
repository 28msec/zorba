...
public:
  ...
  virtual XmlNode* copy(XmlNode* parent, unsigned long pos) = 0;
...
public:
  ...
  XmlNode* copy(XmlNode* parent, unsigned long pos) { Assert(0); return 0; }
...
public:
  ...
  XmlNode* copy(XmlNode* parent, unsigned long pos);
