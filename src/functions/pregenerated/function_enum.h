...
// ******************************************
  ...
  FN_PUT_2,
  ZORBA_FULL_TEXT_CURRENT_LANG_0,
  ZORBA_FULL_TEXT_HOST_LANG_0,
  ZORBA_FULL_TEXT_IS_STEM_LANG_SUPPORTED_1,
  ZORBA_FULL_TEXT_IS_STOP_WORD_LANG_SUPPORTED_1,
  ZORBA_FULL_TEXT_IS_THESAURUS_LANG_SUPPORTED_1,
  ZORBA_FULL_TEXT_IS_THESAURUS_LANG_SUPPORTED_2,
  ...
  ZORBA_FULL_TEXT_TOKENIZE_STRING_1,
  ZORBA_FULL_TEXT_TOKENIZE_STRING_2,
  FN_FUNCTION_NAME_1,
  FN_FUNCTION_ARITY_1,
  FN_PARTIAL_APPLY_2,
  FN_PARTIAL_APPLY_3,
