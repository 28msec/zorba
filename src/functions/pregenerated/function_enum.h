...
// ******************************************
  ...
  JSONIQ_DYNAMIC_COLLECTIONS_DML_COLLECTION_1,
  STATIC_COLLECTIONS_DML_INDEX_OF_1,
  DYNAMIC_COLLECTIONS_DML_INDEX_OF_1,
  JSONIQ_DYNAMIC_COLLECTIONS_DML_INDEX_OF_1,
  ...
  JSONIQ_DYNAMIC_COLLECTIONS_DDL_CREATE_1,
  JSONIQ_DYNAMIC_COLLECTIONS_DDL_CREATE_2,
  STATIC_COLLECTIONS_DDL_DELETE_1,
  DYNAMIC_COLLECTIONS_DDL_DELETE_1,
  JSONIQ_DYNAMIC_COLLECTIONS_DDL_DELETE_1,
  ...
  JSONIQ_DYNAMIC_COLLECTIONS_DML_DELETE_NODE_FIRST_1,
  JSONIQ_DYNAMIC_COLLECTIONS_DML_DELETE_NODES_FIRST_2,
  ...
  FN_JSONIQ_MEMBER_2,
  FN_JSONIQ_FLATTEN_1,
  OP_ZORBA_FLATTEN_INTERNAL_1,
  OP_ZORBA_JSON_ITEM_ACCESSOR_2,
  OP_ZORBA_JSON_EMPTY_ITEM_ACCESSOR_1,
  FN_JSONIQ_VALUES_1,
  FN_JSONIQ_SIZE_1,
  FN_JSONIQ_NULL_0,
  FN_JSONIQ_INSERT_INTO_2,
  FN_JSONIQ_INSERT_AS_FIRST_2,
  FN_JSONIQ_INSERT_AFTER_3,
  FN_JSONIQ_INSERT_BEFORE_3,
  FN_JSONIQ_INSERT_AS_LAST_2,
  FN_JSONIQ_DELETE_PAIR_2,
  FN_JSONIQ_DELETE_MEMBER_2,
  FN_JSONIQ_RENAME_3,
  FN_JSONIQ_REPLACE_VALUE_IN_OBJECT_3,
  FN_JSONIQ_REPLACE_VALUE_IN_ARRAY_3,
  OP_ZORBA_JSON_UNBOX_1,
  MATH_SQRT_1,
  MATH_EXP_1,
  MATH_EXP10_1,
  MATH_LOG_1,
