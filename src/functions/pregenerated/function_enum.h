...
// ******************************************
  ...
  FN_ZORBA_INFO_NODE_INFORMATION_1,
  FN_ZORBA_INFO_ANCESTOR_OF_2,
  FN_ZORBA_INFO_FOLLOWING_SIBLING_OF_2,
  FN_ZORBA_INFO_FOLLOWING_OF_2,
  FN_ZORBA_INFO_DESCENDANT_OF_2,
  FN_ZORBA_INFO_PRECEDING_SIBLING_OF_2,
  FN_ZORBA_INFO_PRECEDING_OF_2,
  FN_ZORBA_INFO_CHILD_OF_2,
  FN_ZORBA_INFO_ATTRIBUTE_OF_2,
  FN_ZORBA_INFO_PARENT_OF_2,
  FN_ZORBA_INFO_PRECEDING_IN_DOCUMENT_ORDER_OF_2,
  FN_ZORBA_INFO_FOLLOWING_IN_DOCUMENT_ORDER_OF_2,
  FN_ZORBA_INFO_LEVEL_1,
  FN_ZORBA_INFO_IS_ATTRIBUTE_1,
  FN_ZORBA_INFO_IS_COMMENT_1,
  FN_ZORBA_INFO_IS_DOCUMENT_1,
  FN_ZORBA_INFO_IS_ELEMENT_1,
  FN_ZORBA_INFO_IS_PROCESSING_INSTRUCTION_1,
  FN_ZORBA_INFO_IS_TEXT_1,
  FN_ZORBA_INFO_SIBLING_OF_2,
  FN_ZORBA_INFO_IN_SAME_TREE_OF_2,
  FN_ZORBA_INFO_IN_COLLECTION_1,
  FN_ZORBA_INFO_IN_SAME_COLLECTION_OF_2,
