...
// ******************************************
  ...
  FN_COLLECTION_0,
  FN_COLLECTION_1,
  FN_ZORBA_XQDDF_COLLECTION_1,
  FN_ZORBA_XQDDF_INDEX_OF_2,
  FN_ZORBA_XQDDF_CREATE_COLLECTION_1,
  FN_ZORBA_XQDDF_CREATE_COLLECTION_2,
  FN_ZORBA_XQDDF_DELETE_COLLECTION_1,
  FN_ZORBA_XQDDF_INSERT_NODES_2,
  FN_ZORBA_XQDDF_INSERT_NODES_FIRST_2,
  FN_ZORBA_XQDDF_INSERT_NODES_LAST_2,
  FN_ZORBA_XQDDF_INSERT_NODES_BEFORE_3,
  FN_ZORBA_XQDDF_INSERT_NODES_AFTER_3,
  FN_ZORBA_XQDDF_DELETE_NODES_2,
  FN_ZORBA_XQDDF_DELETE_NODE_FIRST_1,
  FN_ZORBA_XQDDF_DELETE_NODES_FIRST_2,
  FN_ZORBA_XQDDF_DELETE_NODE_LAST_1,
  FN_ZORBA_XQDDF_DELETE_NODES_LAST_2,
  FN_CURRENT_DATETIME_0,
  FN_CURRENT_DATE_0,
  FN_CURRENT_TIME_0,
  FN_IMPLICIT_TIMEZONE_0,
  FN_DEFAULT_COLLATION_0,
  FN_ZORBA_JSON_PARSE_1,
  FN_ZORBA_JSON_SERIALIZE_1,
  FN_ZORBA_JSON_PARSE_ML_1,
  FN_ZORBA_JSON_SERIALIZE_ML_1,
  FN_ZORBA_CSV_CSV_TO_XML_7,
  FN_ZORBA_CSV_TXT_TO_XML_5,
  FN_ZORBA_CSV_CSV_FILE_TO_XML_7,
  FN_ZORBA_CSV_TXT_FILE_TO_XML_5,
  FN_ZORBA_CSV_XML_TO_CSV_6,
  FN_ZORBA_CSV_XML_TO_CSV_FILE_7,
  FN_ZORBA_CSV_XML_TO_TXT_4,
  FN_ZORBA_CSV_XML_TO_TXT_FILE_5,
  FN_TRACE_2,
  ...
  FN_FUNCTION_NAME_1,
  FN_FUNCTION_ARITY_1,
  FN_ZORBA_XQDDF_ACTIVATE_INTEGRITY_CONSTRAINT_1,
  FN_ZORBA_XQDDF_DEACTIVATE_INTEGRITY_CONSTRAINT_1,
  FN_ZORBA_XQDDF_CHECK_INTEGRITY_CONSTRAINT_1,
