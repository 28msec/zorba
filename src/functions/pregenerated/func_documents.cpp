...
void populate_context_documents(static_context* sctx)
{
  DECL_WITH_KIND(sctx, zorba_store_documents_add,
      (createQName("http://www.zorba-xquery.com/modules/store/documents","","add"),
  ...
  DECL_WITH_KIND(sctx, zorba_store_documents_remove,
      (createQName("http://www.zorba-xquery.com/modules/store/documents","","remove"),
      GENV_TYPESYSTEM.STRING_TYPE_ONE,
      GENV_TYPESYSTEM.EMPTY_TYPE),
  ...
  DECL_WITH_KIND(sctx, zorba_store_documents_document,
      (createQName("http://www.zorba-xquery.com/modules/store/documents","","document"),
      GENV_TYPESYSTEM.STRING_TYPE_ONE,
      GENV_TYPESYSTEM.DOCUMENT_TYPE_ONE),
  ...
  DECL_WITH_KIND(sctx, zorba_store_documents_available_documents,
      (createQName("http://www.zorba-xquery.com/modules/store/documents","","available-documents"),
  ...
  DECL_WITH_KIND(sctx, zorba_store_documents_is_available_document,
      (createQName("http://www.zorba-xquery.com/modules/store/documents","","is-available-document"),
      GENV_TYPESYSTEM.STRING_TYPE_ONE,
