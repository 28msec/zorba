...
void populate_context_booleans(static_context* sctx)
{
  DECL(sctx, op_is_same_node,
      (createQName("http://www.zorba-xquery.com/xquery/internal-functions","op","is-same-node"),
  ...
  DECL(sctx, op_node_before,
      (createQName("http://www.zorba-xquery.com/xquery/internal-functions","op","node-before"),
      GENV_TYPESYSTEM.ANY_NODE_TYPE_QUESTION,
      GENV_TYPESYSTEM.ANY_NODE_TYPE_QUESTION,
      GENV_TYPESYSTEM.BOOLEAN_TYPE_QUESTION));
  ...
  DECL(sctx, op_node_after,
      (createQName("http://www.zorba-xquery.com/xquery/internal-functions","op","node-after"),
      GENV_TYPESYSTEM.ANY_NODE_TYPE_QUESTION,
      GENV_TYPESYSTEM.ANY_NODE_TYPE_QUESTION,
      GENV_TYPESYSTEM.BOOLEAN_TYPE_QUESTION));
