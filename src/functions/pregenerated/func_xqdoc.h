...
//fn-zorba-xqdoc:xqdoc-impl
class fn_zorba_xqdoc_xqdoc_impl : public function
{
public:
  fn_zorba_xqdoc_xqdoc_impl(const signature& sig, FunctionConsts::FunctionKind kind)
    : 
    function(sig, kind)
  {
...
//fn-zorba-xqdoc:xqdoc-options-impl
class fn_zorba_xqdoc_xqdoc_options_impl : public function
{
public:
  fn_zorba_xqdoc_xqdoc_options_impl(const signature& sig, FunctionConsts::FunctionKind kind)
    : 
    function(sig, kind)
  {
