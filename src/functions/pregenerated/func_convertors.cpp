...
PlanIter_t fn_zorba_csv_csv_to_xml::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
...
PlanIter_t fn_zorba_csv_txt_to_xml::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
...
PlanIter_t fn_zorba_csv_csv_file_to_xml::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
...
PlanIter_t fn_zorba_csv_txt_file_to_xml::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
...
PlanIter_t fn_zorba_csv_xml_to_csv::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
...
PlanIter_t fn_zorba_csv_xml_to_csv_file::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
...
PlanIter_t fn_zorba_csv_xml_to_txt::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
...
PlanIter_t fn_zorba_csv_xml_to_txt_file::codegen(
  CompilerCB*,
  static_context* sctx,
  const QueryLoc& loc,
  std::vector<PlanIter_t>& argv,
