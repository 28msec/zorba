...
typedef enum
{
  ...
  FN_ZORBA_EVAL_SIMPLE_1,
  FN_ZORBA_EVAL_UPDATING_1,
  FN_ZORBA_EVAL_SEQUENTIAL_1,

  FN_ZORBA_INVOKE_SIMPLE_N,
  FN_ZORBA_INVOKE_UPDATING_N,
  FN_ZORBA_INVOKE_SEQUENTIAL_N,
