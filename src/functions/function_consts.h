...
typedef enum
{
  ...
  FN_ZORBA_DDL_INDEX_VALUE_POINT_PROBE_N,
  FN_ZORBA_DDL_INDEX_VALUE_RANGE_PROBE_N,
  FN_ZORBA_DDL_INDEX_GENERAL_POINT_PROBE_N,
  FN_ZORBA_DDL_INDEX_GENERAL_RANGE_PROBE_N,
