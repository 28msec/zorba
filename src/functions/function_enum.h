...
#include "functions/function_consts.h"
  ...
  FN_ZORBA_DDL_DROP_COLLECTION_1,
  FN_ZORBA_DDL_DROP_ALL_COLLECTIONS_0,
  FN_ZORBA_DDL_INSERT_NODES_FIRST_2,
  FN_ZORBA_DDL_INSERT_NODES_LAST_2,
  FN_ZORBA_DDL_INSERT_NODES_AT_3,
  FN_ZORBA_DDL_INSERT_NODES_BEFORE_3,
  FN_ZORBA_DDL_INSERT_NODES_AFTER_3,
  FN_ZORBA_DDL_REMOVE_NODES_2,
  FN_ZORBA_DDL_REMOVE_NODE_AT_2,
