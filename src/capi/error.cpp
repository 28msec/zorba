...
namespace zorbac {
  ...
  Error::convert_xquery_error(XQUERY_ERROR error) {
    ...
    switch (error) {
      ...
      case XQP0039_INDEX_IN_NON_DATA_MODULE:
      ...
      case API0029_NODE_DOES_NOT_BELONG_TO_COLLECTION:
      ...
      case API0038_SMTP_SEVER_ERROR_SET_OPTION:
      case API0039_RECIPIENT_SET_OPTION:
      case API0040_MAIL_NOT_SENT:
