...
namespace zorbac {
  ...
  Error::convert_xquery_error(XQUERY_ERROR error) {
    switch (error) {
      ...
      case XQP0029_MODULE_IMPORT_NOT_ALLOWED:
      case XQP0030_DEADLOCK:
      case XQP0036_BREAKITERATOR_CREATION_FAILED:
        return XQC_INTERNAL_ERROR;

      case XQP0017_FILE_ACCESS_DISABLED:
      case XQP0024_XML_DOES_NOT_MATCH_SCHEMA:
        return XQC_DYNAMIC_ERROR;

#ifndef ZORBA_NO_FULL_TEXT
      case XQP8401_THESAURUS_VERSION_MISMATCH:
      case XQP8402_THESAURUS_DATA_ERROR:
        return XQC_INVALID_ARGUMENT;
      ...
      case API0002_XQUERY_COMPILATION_FAILED:
      ...
      case API0005_XQUERY_ALREADY_EXECUTING:
      case API0006_XQUERY_ALREADY_CLOSED:
      case API0007_CANNOT_SERIALIZE_PUL:
      case API0008_NOT_AN_UPDATE_XQUERY:
      case API0009_XQUERY_NOT_COMPILED_IN_DEBUG_MODE:

      case API0040_ITERATOR_IS_NOT_OPEN:
      case API0041_ITERATOR_IS_OPEN_ALREADY:
      case API0042_ITERATOR_QUERY_IS_CLOSED:

      case API0010_THREAD_NOT_INITIALIZED:
      case API0011_INVALID_VARIABLE_QNAME:
      case API0012_INVALID_INDEX:
      case API0013_INAPPROPRIATE_VARIABLE_VALUE:
      case API0014_INVALID_ARGUMENT:
      ...
      case STR0004_INDEX_PARTIAL_KEY_REMOVE:
      ...
      case STR0010_COLLECTION_NODE_ALREADY_IN_COLLECTION:
      case STR0011_COLLECTION_NON_ROOT_NODE:
      case STR0012_COLLECTION_ITEM_MUST_BE_A_NODE:
      case STR0015_IC_ALREADY_EXISTS:
      case STR0016_IC_DOES_NOT_EXIST:
      case STR0020_LOADER_IO_ERROR:
      case STR0021_LOADER_PARSING_ERROR:
      case STR0030_NODEID_ERROR:
      case STR0040_TYPE_ERROR:
      ...
      case XDST0027_INDEX_BAD_KEY_TYPE:
      case XDST0028_INDEX_NOT_DETERMINISTIC:
      case XDST0029_INDEX_INVALID_DATA_SOURCE:
      case XDST0030_INDEX_NON_CONST_DATA_SOURCE:
      case XDST0031_INDEX_HAS_FREE_VARS:
      case XDST0032_INDEX_REFERENCES_CTX_ITEM:
      ...
      case XDST0045_IC_HAS_FREE_VARS:
      case XDST0046_IC_HAS_INVALID_DATA_SOURCE:
      case XDST0047_IC_NOT_DETERMINISTIC:
