...
void end_visit(const GroupByClause& v, void* /*visit_state*/)
{
  ...
  while (NULL != (ngvar = pop_nodestack_var()))
  {
    ...
    expr_t inputExpr = 
    theExprManager->create_wrapper_expr(theRootSctx, loc, inputVar.getp());
...
void end_visit(const CompTextConstructor& v, void* /*visit_state*/)
{
  ...
  expr_t textExpr = theExprManager->create_text_expr(theRootSctx,
                                                     loc,
                                                     text_expr::text_constructor,
                                                     enclosedExpr.getp());
...
void end_visit(const InsertExpr& v, void* /*visit_state*/)
{
  ...
  expr_t lInsert = theExprManager->create_insert_expr(theRootSctx,
                                                      loc,
                                                      v.getType(),
                                                      lSource,
                                                      lTarget);
...
void end_visit(const RenameExpr& v, void* /*visit_state*/)
{
  ...
  expr_t renameExpr = theExprManager->create_rename_expr(theRootSctx,
                                                         loc,
                                                         targetExpr,
                                                         nameExpr);
