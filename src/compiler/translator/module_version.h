 ...
 *
 *  A.B - represents major version A and minor version *at least* B
 *  A.B! - represents exactly major version A and minor version B, no other
 *  A.B-C.0 - represents any major version between A and C; if it is A, then
...
public:
   ...
   * a valid version definition, "#0.0-1000000.0" will be assumed - that is,
   ...
   *      have exactly the same min_major, max_major, and min_minor().
   */
