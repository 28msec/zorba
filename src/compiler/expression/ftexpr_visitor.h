 ...
 *******************************************************************************/
class next_iter_ftselection_visitor : public ftselection_visitor 
{
public:
...
public:
  ...
  void push_back( expr_t e ) { sub_expr_list_.push_back( e ); }

  expr_list_t& get_sub_expr_list() { return sub_expr_list_; }
