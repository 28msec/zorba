...
#line 184 "/home/markos/zorba/zorba/build-gdb/src/compiler/parser/xquery_parser.hpp"
   ...
   enum yytokentype {
     ...
     FOREIGN = 551,
     KEYS = 552,
     BYTE_ORDER_MARK_UTF8 = 553,
     FTCONTAINS_REDUCE = 554,
     RANGE_REDUCE = 555,
     ADDITIVE_REDUCE = 556,
     MULTIPLICATIVE_REDUCE = 557,
     UNION_REDUCE = 558,
     INTERSECT_EXCEPT_REDUCE = 559,
     QVARINDECLLIST_REDUCE = 560,
     COMMA_DOLLAR = 561,
     UNARY_PREC = 562,
     SEQUENCE_TYPE_REDUCE = 563,
     OCCURS_STAR = 564,
     OCCURS_PLUS = 565,
     OCCURS_HOOK = 566,
     STEP_REDUCE = 567
...
/* Line 35 of lalr1.cc  */
#line 680 "/home/markos/zorba/zorba/build-gdb/src/compiler/parser/xquery_parser.hpp"
