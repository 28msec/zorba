...
# define DECL_PARSENODE_VISITOR_VISIT_MEM_FNS( NODE )           \
  ...
  DECL_PARSENODE_VISITOR_VISIT_MEM_FNS( Annotation );
  DECL_PARSENODE_VISITOR_VISIT_MEM_FNS( AnnotationList );
  DECL_PARSENODE_VISITOR_VISIT_MEM_FNS( AnnotationLiteralList );
  ...
  DECL_PARSENODE_VISITOR_VISIT_MEM_FNS( Module );
  ...
  DECL_PARSENODE_VISITOR_VISIT_MEM_FNS( VarNameAndType );
...
/* try-catch-related */
  ...
  // eval
  DECL_PARSENODE_VISITOR_VISIT_MEM_FNS( EvalExpr );
