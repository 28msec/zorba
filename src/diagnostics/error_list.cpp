...
ZORBA_DEF_ERROR( ZGDB0001,CANNOT_CONNECT_TO_CLIENT );
...
ZORBA_DEF_ERROR( ZXQP0029,URI_ACCESS_DENIED );
...
ZORBA_DEF_ERROR( ZXQP0038,INAPPROPRIATE_ZORBA_VERSION );
ZORBA_DEF_ERROR( ZXQP0039,INVALID_VERSION_SPECIFICATION );
ZORBA_DEF_ERROR( ZXQP0040, MISSING_NONDETERMINISTIC_ANNOTATION );
