...
JSoundErrorCode ILLEGAL_CONSTRAINT( "ILLEGAL_CONSTRAINT" );


JSoundErrorCode ILLEGAL_ENUMERATION( "ILLEGAL_ENUMERATION" );
...
JSoundErrorCode ILLEGAL_PATTERN( "ILLEGAL_PATTERN" );
