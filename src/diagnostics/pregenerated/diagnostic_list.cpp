...
JSoundErrorCode DEFAULT_TYPE_MISMATCH( "DEFAULT_TYPE_MISMATCH" );


JSoundErrorCode DUPLICATE_FIELD_DESCRIPTOR_KEY( "DUPLICATE_FIELD_DESCRIPTOR_KEY" );
...
JSoundErrorCode ILLEGAL_EXPLICIT_TIMEZONE( "ILLEGAL_EXPLICIT_TIMEZONE" );
...
JSoundErrorCode ILLEGAL_OBJECT_TYPE( "ILLEGAL_OBJECT_TYPE" );
