...
extern entry const dict_en[] = {
  ...
  { "~FACET_VIOLATION_BadKey", "\"$2\": key" },
  { "~FACET_VIOLATION_BadValue", "value" },
  ...
  { "~ILLEGAL_BASE_TYPE_IncompatibleFacets", "incompatible facet values for \"$4\"" },
  { "~ILLEGAL_BASE_TYPE_MustBeX", "must be \"$4\"" },
  { "~ILLEGAL_BASE_TYPE_NotSubtype", "\"$4\" is not a subtype of \"$5\"" },
  { "~ILLEGAL_FACET_VALUE_BadConstraint", "[$4]: $5" },
  { "~ILLEGAL_FACET_VALUE_BadPattern", "[$4]: $5" },
  ...
  { "~ILLEGAL_FACET_VALUE_NoAddEnum", "can not add value to enumeration of base-type $4" },
  { "~ILLEGAL_FACET_VALUE_NoOverrideBase", "can not override base-type value of \"$4\"" },
