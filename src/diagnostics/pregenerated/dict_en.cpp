...
extern entry const dict_en[] = {
  ...
  { "ZDDY0037", "\"$1\": illegal replace from append-only collection" },
  { "ZDDY0038", "\"$1\": illegal replace from queue collection" },
  { "ZDDY0039", "attempt to replace non-root node in collection \"$1\"" },
