...
extern entry const dict_en[] = {
  ...
  { "ZAPI0024", "non-atomic value can not be assigned to the context size" },
  { "ZAPI0025", "\"$1\": wrong type for context size value (must be integer)" },
  { "ZAPI0026", "non-atomic value can not be assigned to the context position" },
  { "ZAPI0027", "\"$1\": wrong type for context position value (must be integer)" },
