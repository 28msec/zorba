...
extern entry const dict_en[] = {
  ...
  { "~libxml_ERR_201", "${\"5\": }namespace prefix${ for \"7?6:7\"}${ on \"7?7:6\"} not defined" },
  ...
  { "~libxml_ERR_42", "\"$6?{5:}:6$6?6:5\" attribute redefined" },
  ...
  { "~libxml_ERR_503", "element content does not follow DTD" },
