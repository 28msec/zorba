...
extern entry const dict_en[] = {
  ...
  { "~FOFD1340_BadSecondModifierHere_3", "'$3': valid second presentation modifier invalid here" },
  { "~FOFD1340_BadSecondModifier_3", "'$3': invalid second presentation modifier" },
  { "~FOFD1340_BadWidthModifier", "invalid width modifier" },
  { "~FOFD1340_DigitNotSameFamily_34", "\"$3\": digit not from same digit family as $4" },
  { "~FOFD1340_DupSecondModifier_3", "\"$3\": duplicate second presentation modifier" },
