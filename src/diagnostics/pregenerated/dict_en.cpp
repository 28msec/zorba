...
extern entry const dict_en[] = {
  ...
  { "~ZWST0008_APOS_STRING", "single-quote (apostrophe) quoted strings" },
  { "~ZWST0008_CHAR_REF", "XML character entity reference in string literal" },
  { "~ZWST0008_CONTEXT_ITEM_EXPR", "context item expression; use zorba-util:context-item() instead" },
  { "~ZWST0008_DOT_IN_QNAME", "dot \".\" character in QName" },
  { "~ZWST0008_EMPTY_BLOCK", "empty block; use {;} instead" },
  { "~ZWST0008_EMPTY_OBJECT", "empty object; use {| |} instead" },
  { "~ZWST0008_JSONIQ_TYPE_KEYWORDS", "JSONiq type keywords; add \"()\" after type" },
  { "~ZWST0008_JSON_ESCAPE", "JSON character escape sequence in string literal" },
  { "~ZWST0008_JSON_KEYWORD_OPTIONAL", "optional \"json\" keyword in updates" },
  { "~ZWST0008_JSON_OBJECT_LOOKUP", "JSONiq dot object lookup" },
  { "~ZWST0008_NO_PREFIX_IN_TYPE", "no namespace prefix for built-in JSONiq types; add \"xs\" prefix" },
  { "~ZWST0008_TRUE_FALSE_NULL_KEYWORDS", "true/false/null JSONiq keywords" },
