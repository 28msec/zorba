...
extern entry const dict_en[] = {
  ...
  { "~libxml_ERR_200", "invalid use of either the \"xml\" prefix or the \"xmlns\" namespace" },
  { "~libxml_ERR_201", "\"$5\": namespace prefix${ on 7} not defined" },
  { "~libxml_ERR_202", "\"$5\": invalid XML QName" },
  { "~libxml_ERR_203", "\"$5\": attribute in namespace \"$6\" redefined" },
  { "~libxml_ERR_204", "empty namespace for prefix \"$5\"" },
  { "~libxml_ERR_205", "\"$5\": colon is forbidden" },
  ...
  { "~libxml_ERR_502", "invalid attribute value" },
  { "~libxml_ERR_502", "\"$5\": defintion has duplicate references to \"$6\"" },
  { "~libxml_ERR_503", "element does not follow content model" },
  { "~libxml_ERR_51", "')' expected to end ATTLIST enumeration" },
  { "~libxml_ERR_52", "'|' or \")*\" expected for mixed content declaration" },
  { "~libxml_ERR_54", "name${ \"5\"} or '(' expected for content declaration" },
  ...
  { "~libxml_ERR_77", "\"$5\": premature end of content for tag (line $8)" },
  ...
  { "~libxml_WAR_100", "\"xmlns:$5\": URI not absolute" },
  ...
  { "~libxml_WAR_99", "\"xmlns:$5\": invalid URI" },
