...
#endif
  { "~", "'$2': illegal JSON character${ at 3}" },
  { "~", "'\\$2': illegal JSON character escape${ at 3}" },
  { "~", "\"$2\": illegal Unicode code-point${ at 3}" },
  { "~", "unterminated JSON string${ at 2}" },
  { "~", "illegal JSON literal${ at 2}" },
  { "~", "illegal JSON number${ at 2}" },
  { "~", "\"$2\": unexpected JSON token${ at 3}" },
