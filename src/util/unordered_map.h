...
template<
  ...
  class Allocator = std::allocator< std::pair<KeyType const,MappedType> >
>
class unordered_map :
  public zorba::ztd::hashtable<KeyType,MappedType,Hash,KeyEqual,Allocator,
                               ZORBA_UNORDERED_MAP_REHASH_POLICY>
{
  typedef zorba::ztd::hashtable<KeyType,MappedType,Hash,KeyEqual,Allocator,
                                ZORBA_UNORDERED_MAP_REHASH_POLICY> base_type;
