...
#undef TYPED_VAL_CMP
  ...
  PRINTER_VISITOR_DEFINITION (FnFrexpIterator);
  PRINTER_VISITOR_DEFINITION (FnLdexpIterator);
  PRINTER_VISITOR_DEFINITION (FnLog10Iterator);
  PRINTER_VISITOR_DEFINITION (FnModfIterator);
  PRINTER_VISITOR_DEFINITION (FnPowIterator);
  PRINTER_VISITOR_DEFINITION (FnSinhIterator);
