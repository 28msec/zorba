...
#endif
#ifdef ZORBA_WITH_JSON
    class JSONPairOrMemberAccessorIterator;
#endif
#ifdef ZORBA_WITH_JSON
...
#endif
#ifdef ZORBA_WITH_JSON
    virtual void beginVisit ( const JSONPairOrMemberAccessorIterator& ) = 0;
    virtual void endVisit   ( const JSONPairOrMemberAccessorIterator& ) = 0;
#endif
#ifdef ZORBA_WITH_JSON
