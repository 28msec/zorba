...
void PrinterVisitor::beginVisit ( const HostLangWordIterator& a) {
  thePrinter.startBeginVisit("HostLangWordIterator", ++theId);
  printCommons( &a, theId );
  thePrinter.endBeginVisit( theId );
}

void PrinterVisitor::endVisit ( const HostLangWordIterator& ) {
  thePrinter.startEndVisit();
  thePrinter.endEndVisit();
}
// </HostLangWordIterator>
