...
public:
  ...
  YearsFromDurationIterator(static_context* sctx, const QueryLoc& loc,
...
public:
  ...
  MonthsFromDurationIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<MonthsFromDurationIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  DaysFromDurationIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<DaysFromDurationIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  HoursFromDurationIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<HoursFromDurationIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  MinutesFromDurationIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<MinutesFromDurationIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  SecondsFromDurationIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<SecondsFromDurationIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  YearFromDatetimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<YearFromDatetimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  MonthFromDatetimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<MonthFromDatetimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  DayFromDatetimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<DayFromDatetimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  HoursFromDatetimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<HoursFromDatetimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  MinutesFromDatetimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<MinutesFromDatetimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  SecondsFromDatetimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<SecondsFromDatetimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  TimezoneFromDatetimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<TimezoneFromDatetimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  YearFromDateIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<YearFromDateIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  MonthFromDateIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<MonthFromDateIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  DayFromDateIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<DayFromDateIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  TimezoneFromDateIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<TimezoneFromDateIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  HoursFromTimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<HoursFromTimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  MinutesFromTimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<MinutesFromTimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  SecondsFromTimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<SecondsFromTimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
...
public:
  ...
  TimezoneFromTimeIterator(static_context* sctx, const QueryLoc& loc,
  std::vector<PlanIter_t>& aChildren)
  :
  NaryBaseIterator<TimezoneFromTimeIterator, PlanIteratorState>
  (sctx, loc, aChildren){}
