...
#include "runtime/iterators/iterators.h"
...
template class AxisIterator<SelfAxisIterator>;
template class AxisIterator<AttributeAxisIterator>;
template class AxisIterator<ChildAxisIterator>;
template class AxisIterator<ParentAxisIterator>;
template class AxisIterator<DescendantAxisIterator>;
template class AxisIterator<DescendantSelfAxisIterator>;
template class AxisIterator<AncestorAxisIterator>;
template class AxisIterator<AncestorSelfAxisIterator>;
template class AxisIterator<FollowingAxisIterator>;
template class AxisIterator<PrecedingAxisIterator>;
template class AxisIterator<RSiblingAxisIterator>;
template class AxisIterator<LSiblingAxisIterator>;
