 ...
 * Author: Zorba Team
 */
class UtilsParseIterator : public NaryBaseIterator<UtilsParseIterator, PlanIteratorState>
{ 
public:
  SERIALIZABLE_CLASS(UtilsParseIterator);

  SERIALIZABLE_CLASS_CONSTRUCTOR2T(UtilsParseIterator,
    NaryBaseIterator<UtilsParseIterator, PlanIteratorState>);

  void serialize( ::zorba::serialization::Archiver& ar)
  {
    serialize_baseclass(ar,
    (NaryBaseIterator<UtilsParseIterator, PlanIteratorState>*)this);
  }
  ...
  UtilsParseIterator(
    ...
    std::vector<PlanIter_t>& children)
    : 
    NaryBaseIterator<UtilsParseIterator, PlanIteratorState>(sctx, loc, children)
  {}

  virtual ~UtilsParseIterator();
