...
END_SERIALIZABLE_CLASS_VERSIONS(CodepointsToStringIterator)
...
END_SERIALIZABLE_CLASS_VERSIONS(CompareStrIterator)

SERIALIZABLE_CLASS_VERSIONS(CodepointEqualIterator)
END_SERIALIZABLE_CLASS_VERSIONS(CodepointEqualIterator)

SERIALIZABLE_CLASS_VERSIONS(ConcatStrIterator)
END_SERIALIZABLE_CLASS_VERSIONS(ConcatStrIterator)

SERIALIZABLE_CLASS_VERSIONS(StringJoinIterator)
END_SERIALIZABLE_CLASS_VERSIONS(StringJoinIterator)

SERIALIZABLE_CLASS_VERSIONS(SubstringIterator)
END_SERIALIZABLE_CLASS_VERSIONS(SubstringIterator)

SERIALIZABLE_CLASS_VERSIONS(StringLengthIterator)
END_SERIALIZABLE_CLASS_VERSIONS(StringLengthIterator)

SERIALIZABLE_CLASS_VERSIONS(NormalizeSpaceIterator)
END_SERIALIZABLE_CLASS_VERSIONS(NormalizeSpaceIterator)

SERIALIZABLE_CLASS_VERSIONS(NormalizeUnicodeIterator)
END_SERIALIZABLE_CLASS_VERSIONS(NormalizeUnicodeIterator)

SERIALIZABLE_CLASS_VERSIONS(UpperCaseIterator)
END_SERIALIZABLE_CLASS_VERSIONS(UpperCaseIterator)

SERIALIZABLE_CLASS_VERSIONS(LowerCaseIterator)
END_SERIALIZABLE_CLASS_VERSIONS(LowerCaseIterator)

SERIALIZABLE_CLASS_VERSIONS(TranslateIterator)
END_SERIALIZABLE_CLASS_VERSIONS(TranslateIterator)

SERIALIZABLE_CLASS_VERSIONS(EncodeForUriIterator)
END_SERIALIZABLE_CLASS_VERSIONS(EncodeForUriIterator)

SERIALIZABLE_CLASS_VERSIONS(IriToUriIterator)
END_SERIALIZABLE_CLASS_VERSIONS(IriToUriIterator)

SERIALIZABLE_CLASS_VERSIONS(EscapeHtmlUriIterator)
END_SERIALIZABLE_CLASS_VERSIONS(EscapeHtmlUriIterator)

SERIALIZABLE_CLASS_VERSIONS(ContainsIterator)
END_SERIALIZABLE_CLASS_VERSIONS(ContainsIterator)

SERIALIZABLE_CLASS_VERSIONS(StartsWithIterator)
END_SERIALIZABLE_CLASS_VERSIONS(StartsWithIterator)

SERIALIZABLE_CLASS_VERSIONS(EndsWithIterator)
END_SERIALIZABLE_CLASS_VERSIONS(EndsWithIterator)

SERIALIZABLE_CLASS_VERSIONS(SubstringBeforeIterator)
END_SERIALIZABLE_CLASS_VERSIONS(SubstringBeforeIterator)

SERIALIZABLE_CLASS_VERSIONS(SubstringAfterIterator)
END_SERIALIZABLE_CLASS_VERSIONS(SubstringAfterIterator)

SERIALIZABLE_CLASS_VERSIONS(FnMatchesIterator)
END_SERIALIZABLE_CLASS_VERSIONS(FnMatchesIterator)

SERIALIZABLE_CLASS_VERSIONS(FnReplaceIterator)
END_SERIALIZABLE_CLASS_VERSIONS(FnReplaceIterator)
