...
const char* HostLangWordIterator::class_name_str = "HostLangWordIterator";
HostLangWordIterator::class_factory<HostLangWordIterator>
HostLangWordIterator::g_class_factory;

const serialization::ClassVersion 
HostLangWordIterator::class_versions[] ={{ 1, 0x000905, false}};

const int HostLangWordIterator::class_versions_count =
sizeof(HostLangWordIterator::class_versions)/sizeof(struct serialization::ClassVersion);

void HostLangWordIterator::accept(PlanIterVisitor& v) const {
  v.beginVisit(*this);
...
HostLangWordIterator::~HostLangWordIterator() {}
