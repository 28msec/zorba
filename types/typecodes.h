...
//xs_positiveInteger = ITEM_ARITY + VALUE_NODE + DECIMAL_REP + POSITIVE_INTEGER_SUB3,  // no decimal rep yet
	...
	xs_booleanValue = ITEM_ARITY + VALUE_NODE + BOOLEAN_REP + BOOLEAN_PRIM,
	xs_singleFloat = ITEM_ARITY + VALUE_NODE + DOUBLE_REP + FLOAT_PRIM,
	xs_doubleFloat = ITEM_ARITY + VALUE_NODE + DOUBLE_REP + DOUBLE_PRIM,
...
//xs_positiveIntegerSeq = SEQUENCE_ARITY + VALUE_NODE + DECIMAL_REP + POSITIVE_INTEGER_SUB3,  // no decimal rep yet
	...
	xs_booleanValueSeq = SEQUENCE_ARITY + VALUE_NODE + BOOLEAN_REP + BOOLEAN_PRIM,
	xs_singleFloatSeq = SEQUENCE_ARITY + VALUE_NODE + DOUBLE_REP + FLOAT_PRIM,
	xs_doubleFloatSeq = SEQUENCE_ARITY + VALUE_NODE + DOUBLE_REP + DOUBLE_PRIM,
...
//xs_positiveIntegerPlus = NONEMPTY_SEQ_ARITY + VALUE_NODE + DECIMAL_REP + POSITIVE_INTEGER_SUB3,  // no decimal rep yet
	...
	xs_booleanValuePlus = NONEMPTY_SEQ_ARITY + VALUE_NODE + BOOLEAN_REP + BOOLEAN_PRIM,
	xs_singleFloatPlus = NONEMPTY_SEQ_ARITY + VALUE_NODE + DOUBLE_REP + FLOAT_PRIM,
	xs_doubleFloatPlus = NONEMPTY_SEQ_ARITY + VALUE_NODE + DOUBLE_REP + DOUBLE_PRIM,
...
//xs_positiveIntegerOpt = OPT_ITEM_ARITY + VALUE_NODE + DECIMAL_REP + POSITIVE_INTEGER_SUB3,  // no decimal rep yet
	...
	xs_booleanValueOpt = OPT_ITEM_ARITY + VALUE_NODE + BOOLEAN_REP + BOOLEAN_PRIM,
	xs_singleFloatOpt = OPT_ITEM_ARITY + VALUE_NODE + DOUBLE_REP + FLOAT_PRIM,
	xs_doubleFloatOpt = OPT_ITEM_ARITY + VALUE_NODE + DOUBLE_REP + DOUBLE_PRIM,
