...
enum TypeCode {
	...
	documentNodeRef = REF_OBJECT + ITEM_ARITY + DOCUMENT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	documentNodeSeq = SEQUENCE_ARITY + DOCUMENT_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	documentNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + DOCUMENT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	elementNodeRef = REF_OBJECT + ITEM_ARITY + ELEMENT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	elementNodeSeq = SEQUENCE_ARITY + ELEMENT_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	elementNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + ELEMENT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	attributeNodeRef = REF_OBJECT + ITEM_ARITY + ATTRIBUTE_NODE + UNTYPED_ATOMIC_TYPE + REFERENCE_REP,
	attributeNodeSeq = SEQUENCE_ARITY + ATTRIBUTE_NODE + UNTYPED_ATOMIC_TYPE + SEQUENCE_REP,
	attributeNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + ATTRIBUTE_NODE + UNTYPED_ATOMIC_TYPE + REFERENCE_REP,
	...
	namespaceNodeRef = REF_OBJECT + ITEM_ARITY + NAMESPACE_NODE + UNTYPED_TYPE + REFERENCE_REP,
	namespaceNodeSeq = SEQUENCE_ARITY + NAMESPACE_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	namespaceNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + NAMESPACE_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	processingInstructionNodeRef = REF_OBJECT + ITEM_ARITY + PI_NODE + UNTYPED_TYPE + REFERENCE_REP,
	processingInstructionNodeSeq = SEQUENCE_ARITY + PI_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	processingInstructionNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + PI_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	commentNodeRef = REF_OBJECT + ITEM_ARITY + COMMENT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	commentNodeSeq = SEQUENCE_ARITY + COMMENT_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	commentNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + COMMENT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	textNodeRef = REF_OBJECT + ITEM_ARITY + TEXT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	textNodeSeq = SEQUENCE_ARITY + TEXT_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	textNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + TEXT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	anyNodeRef = REF_OBJECT + ITEM_ARITY + ANY_NODE + UNTYPED_TYPE + REFERENCE_REP,
	anyNodeSeq = SEQUENCE_ARITY + ANY_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	anyNodeSeqRef = REF_OBJECT + SEQUENCE_ARITY + ANY_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	xs_stringRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + STRING_TYPE + REFERENCE_REP,
	xs_stringSeq = SEQUENCE_ARITY + NOT_NODE + STRING_TYPE + SEQUENCE_REP,
	xs_stringSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + STRING_TYPE + REFERENCE_REP,
	...
	xs_normalizedStringRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NORMALIZED_STRING_SUB + REFERENCE_REP,
	xs_normalizedStringSeq = SEQUENCE_ARITY + NOT_NODE + NORMALIZED_STRING_SUB + SEQUENCE_REP,
	xs_normalizedStringSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NORMALIZED_STRING_SUB + REFERENCE_REP,
	...
	xs_tokenRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + TOKEN_SUB2 + REFERENCE_REP,
	xs_tokenSeq = SEQUENCE_ARITY + NOT_NODE + TOKEN_SUB2 + SEQUENCE_REP,
	xs_tokenSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + TOKEN_SUB2 + REFERENCE_REP,
	...
	xs_languageRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + LANGUAGE_SUB3 + REFERENCE_REP,
	xs_languageSeq = SEQUENCE_ARITY + NOT_NODE + LANGUAGE_SUB3 + SEQUENCE_REP,
	xs_languageSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + LANGUAGE_SUB3 + REFERENCE_REP,
	...
	xs_nmtokenRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NMTOKEN_SUB3 + REFERENCE_REP,
	xs_nmtokenSeq = SEQUENCE_ARITY + NOT_NODE + NMTOKEN_SUB3 + SEQUENCE_REP,
	xs_nmtokenSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NMTOKEN_SUB3 + REFERENCE_REP,
	...
	xs_nameRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NAME_SUB3 + REFERENCE_REP,
	xs_nameSeq = SEQUENCE_ARITY + NOT_NODE + NAME_SUB3 + SEQUENCE_REP,
	xs_nameSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NAME_SUB3 + REFERENCE_REP,
	...
	xs_ncNameRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NCNAME_SUB4 + REFERENCE_REP,
	xs_ncNameSeq = SEQUENCE_ARITY + NOT_NODE + NCNAME_SUB4 + SEQUENCE_REP,
	xs_ncNameSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NCNAME_SUB4 + REFERENCE_REP,
	...
	xs_idRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + ID_SUB5 + REFERENCE_REP,
	xs_idSeq = SEQUENCE_ARITY + NOT_NODE + ID_SUB5 + SEQUENCE_REP,
	xs_idSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + ID_SUB5 + REFERENCE_REP,
	...
	xs_idrefRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + IDREF_SUB5 + REFERENCE_REP,
	xs_idrefSeq = SEQUENCE_ARITY + NOT_NODE + IDREF_SUB5 + SEQUENCE_REP,
	xs_idrefSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + IDREF_SUB5 + REFERENCE_REP,
	...
	xs_entityRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + ENTITY_SUB5 + REFERENCE_REP,
	xs_entitySeq = SEQUENCE_ARITY + NOT_NODE + ENTITY_SUB5 + SEQUENCE_REP,
	xs_entitySeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + ENTITY_SUB5 + REFERENCE_REP,
	...
	//xs_decimalRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + DECIMAL_TYPE + REFERENCE_REP, 
	//xs_decimalSeq = SEQUENCE_ARITY + NOT_NODE + DECIMAL_TYPE + SEQUENCE_REP, 
	//xs_decimalSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + DECIMAL_TYPE + REFERENCE_REP, 
	...
	xs_decimalRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + DECIMAL_TYPE + REFERENCE_REP,  // no decimal rep yet
	xs_decimalSeq = SEQUENCE_ARITY + NOT_NODE + DECIMAL_TYPE + SEQUENCE_REP,  // no decimal rep yet
	xs_decimalSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + DECIMAL_TYPE + REFERENCE_REP,  // no decimal rep yet
	...
	//xs_integerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + INTEGER_SUB + REFERENCE_REP,
	//xs_integerSeq = SEQUENCE_ARITY + NOT_NODE + INTEGER_SUB + SEQUENCE_REP,
	//xs_integerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + INTEGER_SUB + REFERENCE_REP,
	...
	//xs_nonPositiveIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NON_POSITIVE_INTEGER_SUB2 + REFERENCE_REP, 
	//xs_nonPositiveIntegerSeq = SEQUENCE_ARITY + NOT_NODE + NON_POSITIVE_INTEGER_SUB2 + SEQUENCE_REP, 
	//xs_nonPositiveIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NON_POSITIVE_INTEGER_SUB2 + REFERENCE_REP, 
	...
	xs_nonPositiveIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NON_POSITIVE_INTEGER_SUB2 + REFERENCE_REP,	// no decimal rep yet
	xs_nonPositiveIntegerSeq = SEQUENCE_ARITY + NOT_NODE + NON_POSITIVE_INTEGER_SUB2 + SEQUENCE_REP,	// no decimal rep yet
	xs_nonPositiveIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NON_POSITIVE_INTEGER_SUB2 + REFERENCE_REP,	// no decimal rep yet
	...
	//xs_negativeIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NEGATIVE_INTEGER_SUB3 + REFERENCE_REP,
	//xs_negativeIntegerSeq = SEQUENCE_ARITY + NOT_NODE + NEGATIVE_INTEGER_SUB3 + SEQUENCE_REP,
	//xs_negativeIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NEGATIVE_INTEGER_SUB3 + REFERENCE_REP,
	...
	xs_negativeIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NEGATIVE_INTEGER_SUB3 + REFERENCE_REP,	// no decimal rep yet
	xs_negativeIntegerSeq = SEQUENCE_ARITY + NOT_NODE + NEGATIVE_INTEGER_SUB3 + SEQUENCE_REP,	// no decimal rep yet
	xs_negativeIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NEGATIVE_INTEGER_SUB3 + REFERENCE_REP,	// no decimal rep yet
	...
	//xs_longRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + LONG_SUB2 + REFERENCE_REP,
	//xs_longSeq = SEQUENCE_ARITY + NOT_NODE + LONG_SUB2 + SEQUENCE_REP,
	//xs_longSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + LONG_SUB2 + REFERENCE_REP,
	...
	xs_longRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + LONG_SUB2 + REFERENCE_REP,	// no decimal rep yet
	xs_longSeq = SEQUENCE_ARITY + NOT_NODE + LONG_SUB2 + SEQUENCE_REP,	// no decimal rep yet
	xs_longSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + LONG_SUB2 + REFERENCE_REP,	// no decimal rep yet
	...
	xs_intRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + INT_SUB3 + REFERENCE_REP,
	xs_intSeq = SEQUENCE_ARITY + NOT_NODE + INT_SUB3 + SEQUENCE_REP,
	xs_intSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + INT_SUB3 + REFERENCE_REP,
	...
	xs_shortRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + SHORT_SUB4 + REFERENCE_REP,
	xs_shortSeq = SEQUENCE_ARITY + NOT_NODE + SHORT_SUB4 + SEQUENCE_REP,
	xs_shortSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + SHORT_SUB4 + REFERENCE_REP,
	...
	xs_byteRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + BYTE_SUB5 + REFERENCE_REP,
	xs_byteSeq = SEQUENCE_ARITY + NOT_NODE + BYTE_SUB5 + SEQUENCE_REP,
	xs_byteSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + BYTE_SUB5 + REFERENCE_REP,
	...
	//xs_nonNegativeIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NON_EGATIVE_INTEGER_SUB2 + REFERENCE_REP,
	//xs_nonNegativeIntegerSeq = SEQUENCE_ARITY + NOT_NODE + NON_EGATIVE_INTEGER_SUB2 + SEQUENCE_REP,
	//xs_nonNegativeIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NON_EGATIVE_INTEGER_SUB2 + REFERENCE_REP,
	...
	xs_nonNegativeIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NON_NEGATIVE_INTEGER_SUB2 + REFERENCE_REP,  // no decimal rep yet
	xs_nonNegativeIntegerSeq = SEQUENCE_ARITY + NOT_NODE + NON_NEGATIVE_INTEGER_SUB2 + SEQUENCE_REP,  // no decimal rep yet
	xs_nonNegativeIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NON_NEGATIVE_INTEGER_SUB2 + REFERENCE_REP,  // no decimal rep yet
	...
	//xs_unsignedLongRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + UNSIGNED_LONG_SUB3 + REFERENCE_REP,
	//xs_unsignedLongSeq = SEQUENCE_ARITY + NOT_NODE + UNSIGNED_LONG_SUB3 + SEQUENCE_REP,
	//xs_unsignedLongSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + UNSIGNED_LONG_SUB3 + REFERENCE_REP,
	...
	xs_unsignedLongRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + UNSIGNED_LONG_SUB3 + REFERENCE_REP,	// no decimal rep yet
	xs_unsignedLongSeq = SEQUENCE_ARITY + NOT_NODE + UNSIGNED_LONG_SUB3 + SEQUENCE_REP,	// no decimal rep yet
	xs_unsignedLongSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + UNSIGNED_LONG_SUB3 + REFERENCE_REP,	// no decimal rep yet
	...
	xs_unsignedIntRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + UNSIGNED_INT_SUB4 + REFERENCE_REP,
	xs_unsignedIntSeq = SEQUENCE_ARITY + NOT_NODE + UNSIGNED_INT_SUB4 + SEQUENCE_REP,
	xs_unsignedIntSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + UNSIGNED_INT_SUB4 + REFERENCE_REP,
	...
	xs_unsignedShortRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + UNSIGNED_SHORT_SUB5 + REFERENCE_REP,
	xs_unsignedShortSeq = SEQUENCE_ARITY + NOT_NODE + UNSIGNED_SHORT_SUB5 + SEQUENCE_REP,
	xs_unsignedShortSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + UNSIGNED_SHORT_SUB5 + REFERENCE_REP,
	...
	xs_unsignedByteRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + UNSIGNED_BYTE_SUB6 + REFERENCE_REP,
	xs_unsignedByteSeq = SEQUENCE_ARITY + NOT_NODE + UNSIGNED_BYTE_SUB6 + SEQUENCE_REP,
	xs_unsignedByteSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + UNSIGNED_BYTE_SUB6 + REFERENCE_REP,
...
//xs_positiveIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + POSITIVE_INTEGER_SUB3 + REFERENCE_REP,  // no decimal rep yet
//xs_positiveIntegerSeq = SEQUENCE_ARITY + NOT_NODE + POSITIVE_INTEGER_SUB3 + SEQUENCE_REP,  // no decimal rep yet
//xs_positiveIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + POSITIVE_INTEGER_SUB3 + REFERENCE_REP,  // no decimal rep yet
...
//xs_positiveIntegerOpt = OPT_ITEM_ARITY + NOT_NODE + POSITIVE_INTEGER_SUB3 + NO_REP,  // no decimal rep yet
	...
	xs_positiveIntegerRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + POSITIVE_INTEGER_SUB3 + REFERENCE_REP,
	xs_positiveIntegerSeq = SEQUENCE_ARITY + NOT_NODE + POSITIVE_INTEGER_SUB3 + SEQUENCE_REP,
	xs_positiveIntegerSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + POSITIVE_INTEGER_SUB3 + REFERENCE_REP,
	...
	xs_untypedValueRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	xs_untypedValueSeq = SEQUENCE_ARITY + NOT_NODE + UNTYPED_TYPE + SEQUENCE_REP,
	xs_untypedValueSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + UNTYPED_TYPE + REFERENCE_REP,
	...
	xs_untypedAtomicValueRef = REF_OBJECT + ITEM_ARITY + NOT_NODE+ UNTYPED_ATOMIC_TYPE + REFERENCE_REP ,
	xs_untypedAtomicValueSeq = SEQUENCE_ARITY + NOT_NODE+ UNTYPED_ATOMIC_TYPE + SEQUENCE_REP ,
	xs_untypedAtomicValueSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE+ UNTYPED_ATOMIC_TYPE + REFERENCE_REP ,
	...
	xs_booleanRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + BOOLEAN_TYPE + REFERENCE_REP,
	xs_booleanSeq = SEQUENCE_ARITY + NOT_NODE + BOOLEAN_TYPE + SEQUENCE_REP,
	xs_booleanSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + BOOLEAN_TYPE + REFERENCE_REP,
	...
	xs_floatRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + FLOAT_TYPE + REFERENCE_REP,
	xs_floatSeq = SEQUENCE_ARITY + NOT_NODE + FLOAT_TYPE + SEQUENCE_REP,
	xs_floatSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + FLOAT_TYPE + REFERENCE_REP,
	...
	xs_doubleRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + DOUBLE_TYPE + REFERENCE_REP,
	xs_doubleSeq = SEQUENCE_ARITY + NOT_NODE + DOUBLE_TYPE + SEQUENCE_REP,
	xs_doubleSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + DOUBLE_TYPE + REFERENCE_REP,
	...
	xs_durationRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + DURATION_TYPE + REFERENCE_REP,
	xs_durationSeq = SEQUENCE_ARITY + NOT_NODE + DURATION_TYPE + SEQUENCE_REP,
	xs_durationSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + DURATION_TYPE + REFERENCE_REP,
	...
	xs_dayTimeDurationRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + DAY_TIME_DURATION_SUB + REFERENCE_REP,
	xs_dayTimeDurationSeq = SEQUENCE_ARITY + NOT_NODE + DAY_TIME_DURATION_SUB + SEQUENCE_REP,
	xs_dayTimeDurationSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + DAY_TIME_DURATION_SUB + REFERENCE_REP,
	...
	xs_yearMonthDurationRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + YEAR_MONTH_DURATION_SUB + REFERENCE_REP,
	xs_yearMonthDurationSeq = SEQUENCE_ARITY + NOT_NODE + YEAR_MONTH_DURATION_SUB + SEQUENCE_REP,
	xs_yearMonthDurationSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + YEAR_MONTH_DURATION_SUB + REFERENCE_REP,
	...
	xs_dateTimeRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + DATE_TIME_TYPE + REFERENCE_REP,
	xs_dateTimeSeq = SEQUENCE_ARITY + NOT_NODE + DATE_TIME_TYPE + SEQUENCE_REP,
	xs_dateTimeSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + DATE_TIME_TYPE + REFERENCE_REP,
	...
	xs_timeRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + TIME_TYPE + REFERENCE_REP,
	xs_timeSeq = SEQUENCE_ARITY + NOT_NODE + TIME_TYPE + SEQUENCE_REP,
	xs_timeSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + TIME_TYPE + REFERENCE_REP,
	...
	xs_dateRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + DATE_TYPE + REFERENCE_REP,
	xs_dateSeq = SEQUENCE_ARITY + NOT_NODE + DATE_TYPE + SEQUENCE_REP,
	xs_dateSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + DATE_TYPE + REFERENCE_REP,
	...
	xs_gYearMonthRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + G_YEAR_MONTH_TYPE + REFERENCE_REP,
	xs_gYearMonthSeq = SEQUENCE_ARITY + NOT_NODE + G_YEAR_MONTH_TYPE + SEQUENCE_REP,
	xs_gYearMonthSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + G_YEAR_MONTH_TYPE + REFERENCE_REP,
	...
	xs_gYearRef = REF_OBJECT + ITEM_ARITY + NOT_NODE+ G_YEAR_TYPE + REFERENCE_REP ,
	xs_gYearSeq = SEQUENCE_ARITY + NOT_NODE+ G_YEAR_TYPE + SEQUENCE_REP ,
	xs_gYearSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE+ G_YEAR_TYPE + REFERENCE_REP ,
	...
	xs_gMonthDayRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + G_MONTH_DAY_TYPE + REFERENCE_REP,
	xs_gMonthDaySeq = SEQUENCE_ARITY + NOT_NODE + G_MONTH_DAY_TYPE + SEQUENCE_REP,
	xs_gMonthDaySeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + G_MONTH_DAY_TYPE + REFERENCE_REP,
	...
	xs_gDayRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + G_DAY_TYPE + REFERENCE_REP,
	xs_gDaySeq = SEQUENCE_ARITY + NOT_NODE + G_DAY_TYPE + SEQUENCE_REP,
	xs_gDaySeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + G_DAY_TYPE + REFERENCE_REP,
	...
	xs_gMonthRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + G_MONTH_TYPE + REFERENCE_REP,
	xs_gMonthSeq = SEQUENCE_ARITY + NOT_NODE + G_MONTH_TYPE + SEQUENCE_REP,
	xs_gMonthSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + G_MONTH_TYPE + REFERENCE_REP,
	...
	xs_hexBinaryRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + HEX_BINARY_TYPE + REFERENCE_REP,
	xs_hexBinarySeq = SEQUENCE_ARITY + NOT_NODE + HEX_BINARY_TYPE + SEQUENCE_REP,
	xs_hexBinarySeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + HEX_BINARY_TYPE + REFERENCE_REP,
	...
	xs_base64BinaryRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + BASE_64_BINARY_TYPE + REFERENCE_REP,
	xs_base64BinarySeq = SEQUENCE_ARITY + NOT_NODE + BASE_64_BINARY_TYPE + SEQUENCE_REP,
	xs_base64BinarySeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + BASE_64_BINARY_TYPE + REFERENCE_REP,
	...
	xs_anyURIRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + ANY_URI_TYPE + REFERENCE_REP,
	xs_anyURISeq = SEQUENCE_ARITY + NOT_NODE + ANY_URI_TYPE + SEQUENCE_REP,
	xs_anyURISeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + ANY_URI_TYPE + REFERENCE_REP,
	...
	xs_qnameRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + QNAME_TYPE + REFERENCE_REP,
	xs_qnameSeq = SEQUENCE_ARITY + NOT_NODE + QNAME_TYPE + SEQUENCE_REP,
	xs_qnameSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + QNAME_TYPE + REFERENCE_REP,
	...
	xs_notationRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NOTATION_TYPE + REFERENCE_REP,
	xs_notationSeq = SEQUENCE_ARITY + NOT_NODE + NOTATION_TYPE + SEQUENCE_REP,
	xs_notationSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NOTATION_TYPE + REFERENCE_REP,
	...
	xs_complexType = ITEM_ARITY + NOT_NODE + NOTATION_TYPE + QNAME_REP,
	xs_complexTypeRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + NOTATION_TYPE + REFERENCE_REP,
	xs_complexTypeSeq = SEQUENCE_ARITY + NOT_NODE + NOTATION_TYPE + SEQUENCE_REP,
	xs_complexTypeSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + NOTATION_TYPE + REFERENCE_REP,
	xs_complexTypePlus = NONEMPTY_SEQ_ARITY + NOT_NODE + NOTATION_TYPE + NO_REP,
	xs_complexTypeOpt = OPT_ITEM_ARITY + NOT_NODE + NOTATION_TYPE + NO_REP,
	xs_emptyType = ITEM_ARITY + NOT_NODE + EMPTY_TYPE + NO_REP,
	xs_emptyTypeRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + EMPTY_TYPE + REFERENCE_REP,
	xs_emptyTypeSeq = SEQUENCE_ARITY + NOT_NODE + EMPTY_TYPE + SEQUENCE_REP,
	xs_emptyTypeSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + EMPTY_TYPE + REFERENCE_REP,
	...
	xs_anyTypeRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + ANY_TYPE + REFERENCE_REP,
	xs_anyTypeSeq = SEQUENCE_ARITY + NOT_NODE + ANY_TYPE + SEQUENCE_REP,
	xs_anyTypeSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + ANY_TYPE + REFERENCE_REP,
	...
	xs_rawBinaryTypeRef = REF_OBJECT + ITEM_ARITY + NOT_NODE + RAW_BINARY_TYPE + REFERENCE_REP,
	xs_rawBinaryTypeSeq = SEQUENCE_ARITY + NOT_NODE + RAW_BINARY_TYPE + SEQUENCE_REP,
	xs_rawBinaryTypeSeqRef = REF_OBJECT + SEQUENCE_ARITY + NOT_NODE + RAW_BINARY_TYPE + REFERENCE_REP,
