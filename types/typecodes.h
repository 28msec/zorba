...
static const int ISNUMERIC_MASK = 1 << 21;
static const int ISNUMERIC_SHIFT = 21;
...
// ISNUMERIC distinguishes numeric (DECIMAL_TYPE, FLOAT_TYPE, DOUBLE_TYPE) from other types
static const int NOT_NUMERIC_TYPE = 0 << ISNUMERIC_SHIFT;
static const int NUMERIC_TYPE = 1 << ISNUMERIC_SHIFT;
...
static const int DECIMAL_TYPE = NUMERIC_TYPE | 3 << TYPE_SHIFT;
static const int BOOLEAN_TYPE = 4 << TYPE_SHIFT;
static const int FLOAT_TYPE = NUMERIC_TYPE | 5 << TYPE_SHIFT;
static const int DOUBLE_TYPE = NUMERIC_TYPE | 6 << TYPE_SHIFT;
...
static const int NUMERIC_REP = 9 << REP_SHIFT;
static const int BOOLEAN_REP = 10 << REP_SHIFT;
static const int TIME_REP = 11 << REP_SHIFT;
static const int BINARY_REP = 12 << REP_SHIFT;
static const int QNAME_REP = 13 << REP_SHIFT;
static const int COMPLEX_TYPE_REP = 14 << REP_SHIFT;
static const int TYPE_REP = 15 << REP_SHIFT;
...
enum TypeCode {
	...
	documentNodeSeq = SEQUENCE_ARITY | DOCUMENT_NODE | UNTYPED_TYPE | NO_REP,
	...
	elementNodeSeq = SEQUENCE_ARITY | ELEMENT_NODE | UNTYPED_TYPE | NO_REP,
	...
	attributeNodeSeq = SEQUENCE_ARITY | ATTRIBUTE_NODE | UNTYPED_ATOMIC_TYPE | NO_REP,
	...
	namespaceNodeSeq = SEQUENCE_ARITY | NAMESPACE_NODE | UNTYPED_TYPE | NO_REP,
	...
	processingInstructionNodeSeq = SEQUENCE_ARITY | PI_NODE | UNTYPED_TYPE | NO_REP,
	...
	commentNodeSeq = SEQUENCE_ARITY | COMMENT_NODE | UNTYPED_TYPE | NO_REP,
	...
	textNodeSeq = SEQUENCE_ARITY | TEXT_NODE | UNTYPED_TYPE | NO_REP,
	...
	anyNodeSeq = SEQUENCE_ARITY | ANY_NODE | UNTYPED_TYPE | NO_REP,
	...
	xs_stringSeq = SEQUENCE_ARITY | NOT_NODE | STRING_TYPE | NO_REP,
	...
	xs_normalizedStringSeq = SEQUENCE_ARITY | NOT_NODE | NORMALIZED_STRING_SUB | NO_REP,
	...
	xs_tokenSeq = SEQUENCE_ARITY | NOT_NODE | TOKEN_SUB2 | NO_REP,
	...
	xs_languageSeq = SEQUENCE_ARITY | NOT_NODE | LANGUAGE_SUB3 | NO_REP,
	...
	xs_nmtokenSeq = SEQUENCE_ARITY | NOT_NODE | NMTOKEN_SUB3 | NO_REP,
	...
	xs_nameSeq = SEQUENCE_ARITY | NOT_NODE | NAME_SUB3 | NO_REP,
	...
	xs_ncNameSeq = SEQUENCE_ARITY | NOT_NODE | NCNAME_SUB4 | NO_REP,
	...
	xs_idSeq = SEQUENCE_ARITY | NOT_NODE | ID_SUB5 | NO_REP,
	...
	xs_idrefSeq = SEQUENCE_ARITY | NOT_NODE | IDREF_SUB5 | NO_REP,
	...
	xs_entitySeq = SEQUENCE_ARITY | NOT_NODE | ENTITY_SUB5 | NO_REP,
	xs_entityPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | ENTITY_SUB5 | NO_REP,
	xs_entityOpt = OPT_ITEM_ARITY | NOT_NODE | ENTITY_SUB5 | NO_REP,

	// Numeric values.
	xs_decimal = ITEM_ARITY | NOT_NODE | DECIMAL_TYPE | NUMERIC_REP,
	xs_decimalSeq = SEQUENCE_ARITY | NOT_NODE | DECIMAL_TYPE | NO_REP,
	xs_decimalPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | DECIMAL_TYPE | NO_REP,
	xs_decimalOpt = OPT_ITEM_ARITY | NOT_NODE | DECIMAL_TYPE | NO_REP,
	xs_integer = ITEM_ARITY | NOT_NODE | INTEGER_SUB | NUMERIC_REP,
	xs_integerSeq = SEQUENCE_ARITY | NOT_NODE | INTEGER_SUB | NO_REP,
	xs_integerPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | INTEGER_SUB | NO_REP,
	xs_integerOpt = OPT_ITEM_ARITY | NOT_NODE | INTEGER_SUB | NO_REP,
	xs_nonPositiveInteger = ITEM_ARITY | NOT_NODE | NON_POSITIVE_INTEGER_SUB2 | NUMERIC_REP,
	xs_nonPositiveIntegerSeq = SEQUENCE_ARITY | NOT_NODE | NON_POSITIVE_INTEGER_SUB2 | NO_REP,
	...
	xs_negativeInteger = ITEM_ARITY | NOT_NODE | NEGATIVE_INTEGER_SUB3 | NUMERIC_REP,
	xs_negativeIntegerSeq = SEQUENCE_ARITY | NOT_NODE | NEGATIVE_INTEGER_SUB3 | NO_REP,
	...
	xs_long = ITEM_ARITY | NOT_NODE | LONG_SUB2 | NUMERIC_REP,
	xs_longSeq = SEQUENCE_ARITY | NOT_NODE | LONG_SUB2 | NO_REP,
	xs_longPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | LONG_SUB2 | NO_REP,
	xs_longOpt = OPT_ITEM_ARITY | NOT_NODE | LONG_SUB2 | NO_REP,
	xs_int = ITEM_ARITY | NOT_NODE | INT_SUB3 | NUMERIC_REP,
	xs_intSeq = SEQUENCE_ARITY | NOT_NODE | INT_SUB3 | NO_REP,
	xs_intPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | INT_SUB3 | NO_REP,
	xs_intOpt = OPT_ITEM_ARITY | NOT_NODE | INT_SUB3 | NO_REP,
	xs_short = ITEM_ARITY | NOT_NODE | SHORT_SUB4 | NUMERIC_REP,
	xs_shortSeq = SEQUENCE_ARITY | NOT_NODE | SHORT_SUB4 | NO_REP,
	xs_shortPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | SHORT_SUB4 | NO_REP,
	xs_shortOpt = OPT_ITEM_ARITY | NOT_NODE | SHORT_SUB4 | NO_REP,
	xs_byte = ITEM_ARITY + NOT_NODE + BYTE_SUB5 + NUMERIC_REP,
	xs_byteSeq = SEQUENCE_ARITY + NOT_NODE + BYTE_SUB5 + NO_REP,
	xs_bytePlus = NONEMPTY_SEQ_ARITY + NOT_NODE + BYTE_SUB5 + NO_REP,
	xs_byteOpt = OPT_ITEM_ARITY + NOT_NODE + BYTE_SUB5 + NO_REP,
	xs_nonNegativeInteger = ITEM_ARITY | NOT_NODE | NON_NEGATIVE_INTEGER_SUB2 | NUMERIC_REP,
	xs_nonNegativeIntegerSeq = SEQUENCE_ARITY | NOT_NODE | NON_NEGATIVE_INTEGER_SUB2 | NO_REP,
	xs_nonNegativeIntegerPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | NON_NEGATIVE_INTEGER_SUB2 | NO_REP,
	xs_nonNegativeIntegerOpt = OPT_ITEM_ARITY | NOT_NODE | NON_NEGATIVE_INTEGER_SUB2 | NO_REP,
	xs_unsignedLong = ITEM_ARITY | NOT_NODE | UNSIGNED_LONG_SUB3 | NUMERIC_REP,
	xs_unsignedLongSeq = SEQUENCE_ARITY | NOT_NODE | UNSIGNED_LONG_SUB3 | NO_REP,
	...
	xs_unsignedShort = ITEM_ARITY | NOT_NODE | UNSIGNED_SHORT_SUB5 | NUMERIC_REP,
	xs_unsignedShortSeq = SEQUENCE_ARITY | NOT_NODE | UNSIGNED_SHORT_SUB5 | NO_REP,
	...
	xs_unsignedInt = ITEM_ARITY + NOT_NODE + UNSIGNED_INT_SUB4 + NUMERIC_REP,
	xs_unsignedIntSeq = SEQUENCE_ARITY + NOT_NODE + UNSIGNED_INT_SUB4 + NO_REP,
	...
	xs_unsignedByte = ITEM_ARITY + NOT_NODE + UNSIGNED_BYTE_SUB6 + NUMERIC_REP,
	xs_unsignedByteSeq = SEQUENCE_ARITY + NOT_NODE + UNSIGNED_BYTE_SUB6 + NO_REP,
	...
	xs_positiveInteger = ITEM_ARITY | NOT_NODE | POSITIVE_INTEGER_SUB3 | NUMERIC_REP,
	xs_positiveIntegerSeq = SEQUENCE_ARITY | NOT_NODE | POSITIVE_INTEGER_SUB3 | NO_REP,
	...
	xs_untypedValueSeq = SEQUENCE_ARITY | NOT_NODE | UNTYPED_TYPE | NO_REP,
	...
	xs_untypedAtomicValueSeq = SEQUENCE_ARITY | NOT_NODE| UNTYPED_ATOMIC_TYPE | NO_REP,
	...
	xs_booleanSeq = SEQUENCE_ARITY | NOT_NODE | BOOLEAN_TYPE | NO_REP,
	xs_booleanPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | BOOLEAN_TYPE | NO_REP,
	xs_booleanOpt = OPT_ITEM_ARITY | NOT_NODE | BOOLEAN_TYPE | NO_REP,
	xs_float = ITEM_ARITY | NOT_NODE | FLOAT_TYPE | NUMERIC_REP,
	xs_floatSeq = SEQUENCE_ARITY | NOT_NODE | FLOAT_TYPE | NO_REP,
	xs_floatPlus = NONEMPTY_SEQ_ARITY | NOT_NODE | FLOAT_TYPE | NO_REP,
	xs_floatOpt = OPT_ITEM_ARITY | NOT_NODE | FLOAT_TYPE | NO_REP,
	xs_double = ITEM_ARITY | NOT_NODE | DOUBLE_TYPE | NUMERIC_REP,
	xs_doubleSeq = SEQUENCE_ARITY | NOT_NODE | DOUBLE_TYPE | NO_REP,
	...
	xs_durationSeq = SEQUENCE_ARITY | NOT_NODE | DURATION_TYPE | NO_REP,
	...
	xs_dayTimeDurationSeq = SEQUENCE_ARITY | NOT_NODE | DAY_TIME_DURATION_SUB | NO_REP,
	...
	xs_yearMonthDurationSeq = SEQUENCE_ARITY | NOT_NODE | YEAR_MONTH_DURATION_SUB | NO_REP,
	...
	xs_dateTimeSeq = SEQUENCE_ARITY | NOT_NODE | DATE_TIME_TYPE | NO_REP,
	...
	xs_timeSeq = SEQUENCE_ARITY | NOT_NODE | TIME_TYPE | NO_REP,
	...
	xs_dateSeq = SEQUENCE_ARITY | NOT_NODE | DATE_TYPE | NO_REP,
	...
	xs_gYearMonthSeq = SEQUENCE_ARITY | NOT_NODE | G_YEAR_MONTH_TYPE | NO_REP,
	...
	xs_gYearSeq = SEQUENCE_ARITY | NOT_NODE| G_YEAR_TYPE | NO_REP,
	...
	xs_gMonthDaySeq = SEQUENCE_ARITY | NOT_NODE | G_MONTH_DAY_TYPE | NO_REP,
	...
	xs_gDaySeq = SEQUENCE_ARITY | NOT_NODE | G_DAY_TYPE | NO_REP,
	...
	xs_gMonthSeq = SEQUENCE_ARITY | NOT_NODE | G_MONTH_TYPE | NO_REP,
	...
	xs_hexBinarySeq = SEQUENCE_ARITY | NOT_NODE | HEX_BINARY_TYPE | NO_REP,
	...
	xs_base64BinarySeq = SEQUENCE_ARITY | NOT_NODE | BASE_64_BINARY_TYPE | NO_REP,
	...
	xs_anyURISeq = SEQUENCE_ARITY | NOT_NODE | ANY_URI_TYPE | NO_REP,
	...
	xs_qnameSeq = SEQUENCE_ARITY | NOT_NODE | QNAME_TYPE | NO_REP,
	...
	xs_notationSeq = SEQUENCE_ARITY | NOT_NODE | NOTATION_TYPE | NO_REP,
	...
	xs_complexTypeSeq = SEQUENCE_ARITY | NOT_NODE | COMPLEX_TYPE | NO_REP,
	...
	xs_emptyTypeSeq = SEQUENCE_ARITY | NOT_NODE | EMPTY_TYPE | NO_REP,
	...
	xs_anyTypeSeq = SEQUENCE_ARITY | NOT_NODE | ANY_TYPE | NO_REP,
	...
	xs_rawBinaryTypeSeq = SEQUENCE_ARITY | NOT_NODE | RAW_BINARY_TYPE | NO_REP,
	...
	xs_typeTypeSeq = SEQUENCE_ARITY | NOT_NODE | TYPE_TYPE | NO_REP,
