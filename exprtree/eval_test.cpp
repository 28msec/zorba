...
int main(int argc, char* argv[])
{
	...
	uint32_t i1 = ctx.put_string("symbol1");
	uint32_t i2 = ctx.put_string("symbol2");
	uint32_t i3 = ctx.put_string("symbol3");
	...
	*/
		...
		cout << "\n>>>elem_expr\n";
		rchandle<elem_expr> elem1_h = new elem_expr(loc, &ctx, &*qne1_h, &*exlist2_h);
