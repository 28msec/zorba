(:~
 : This example shows how to use the subscribe function of the http://www.zorba-xquery.com/modules/email/imap module.
 ...
 : This example is the same example as for the unsubscribe function.
 :
 :) 
