...
{
  CREATE_FOO_SEQUENCE_TEST(int, %d, integer, XQC_DECIMAL_TYPE);
}
...
{
  CREATE_FOO_SEQUENCE_TEST(double, %f, double, XQC_DOUBLE_TYPE);
}
...
{
  CREATE_FOO_SEQUENCE_TEST(const char*, %s, string, XQC_STRING_TYPE);
}
