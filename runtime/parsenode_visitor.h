...
class AposAttrValueContent; class ArgList; class AtomicType;
class AttribNameOrWildcard; class AttributeDeclaration; class AttributeName;
class AttributeTest; class BaseURIDecl; class BoundarySpaceDecl;
class CaseClause; class CaseClauseList; class CommentTest; class ConstructionDecl;
class CopyNamespacesDecl; class DefaultCollationDecl; class DefaultNamespaceDecl;
class DirAttr; class DirAttributeList; class DirAttributeValue;
class DirElemContentList; class DocumentTest; class ElementDeclaration;
class ElementName; class ElementNameOrWildcard; class ElementTest;
class EmptyOrderDecl; class ForClause; class ForLetClause; class ForLetClauseList;
class ForwardAxis; class ForwardStep; class FunctionDecl; class GeneralComp;
class Import; class InheritMode; class ItemType; class KindTest; class LetClause;
class LibraryModule; class MainModule ; class Module; class ModuleDecl;
class ModuleImport; class NameTest; class NamespaceDecl; class NodeComp;
class NodeTest; class OccurrenceIndicator; class OptionDecl; class OrderByClause;
...
class PITest; class Param; class ParamList; class PositionalVar; class Pragma;
class PragmaList; class PredicateList; class PreserveMode; class Prolog;
class QVarInDecl; class QVarInDeclList; class QuoteAttrValueContent;
...
public:
 ...
 /*..........................................
	...
	virtual bool begin_visit(AttribNameOrWildcard const&) = 0;
	virtual bool begin_visit(AttributeDeclaration const&) = 0;
	virtual bool begin_visit(AttributeName const&) = 0;
	...
	virtual bool begin_visit(ElementDeclaration const&) = 0;
	virtual bool begin_visit(ElementName const&) = 0;
	virtual bool begin_visit(ElementNameOrWildcard const&) = 0;
	...
	virtual bool begin_visit(Setter const&) = 0;
...
/* full-text-related */
 ...
 /*..........................................
	...
	virtual void end_visit(AttribNameOrWildcard const&) = 0;
	virtual void end_visit(AttributeDeclaration const&) = 0;
	virtual void end_visit(AttributeName const&) = 0;
	...
	virtual void end_visit(ElementDeclaration const&) = 0;
	virtual void end_visit(ElementName const&) = 0;
	virtual void end_visit(ElementNameOrWildcard const&) = 0;
	...
	virtual void end_visit(Setter const&) = 0;
