...
protected:	// XQuery 1.0 static context
  ...
  std::vector<name_space> namespaces;
	...
	*/
	hashmap<static_type_t> statically_known_documents;
	...
	*/
	hashmap<static_type_t> statically_known_collections;
	...
	*/
	hashmap<static_type_t> statically_known_collection_types;
