...
(:~
 ...
 :
 : @see <a href="http://office.microsoft.com/en-us/excel/CH062528321033.aspx">Excel Documentation</a>
...
(:  helper functions    :)
(:~
 : Helper function: returns the union of the values in two sequences in an implementation-defined order. It removes duplicates.
 : 
...
(:~
 : Helper function: returns the intersection of the values in two sequences in an implementation-defined order. It removes duplicates.
 : 
 : @param   $arg1 the first sequence
 : @param   $arg2 the second sequence
 :)  
...
(:~
 : Helper function: returns the values in one sequence that do not appear in the second sequence in an implementation-defined order.
 : 
 : @param   $arg1 the first sequence
 : @param   $arg2 the second sequence
 :)  
...
(:~
 : Helper function: reverses the order of characters in a string. It returns a zero-length string if the argument is the empty sequence.
 : 
...
(:~
 : Helper function: returns $toPad appended with enough repetitions of $padChar to make its length $length, the characters are added before the string. 
 : 
...
(:~
 : Helper function: returns an integer representing the first position of a substring that matches $pattern using $flags within $arg. 
 : If $arg does not match $pattern, the empty sequence is returned. 
 : 
 : @param   $arg the string
 : @param   $pattern the pattern to match
...
(:~
 : Helper function: returns an integer representing the $instance_num position of a substring that matches $pattern within $arg starting from $pos. 
 : If $arg does not match $pattern, the empty sequence is returned. 
 : 
 : @param   $arg the string
 : @param   $pattern the pattern to match
...
(:~
 : Removes all nonprintable characters from text. The CLEAN function was designed to remove the first 32 nonprinting characters 
 :in the 7-bit ASCII code (values 0 through 31) from text. In the Unicode character set, there are additional 
 :nonprinting characters (values 127, 129, 141, 143, 144, and 157). By itself, the CLEAN function does not remove these 
 :additional nonprinting characters.
 :
...
(:~
 ...
 : @param   $number is the number you want to round and convert to text
 : @param   $decimals is the number of digits to the right of the decimal point
 : @param   $no_commas is a logical value that, if TRUE, prevents FIXED from including commas in the returned text.
 :)
declare function excel-text:fixed
  ( $number     as xs:decimal,
...
(:~
 : Converts a number to text format and applies a currency symbol. the number of digits to the right of the decimal point is two.
 :
 : @see     http://office.microsoft.com/en-us/excel/HP052090931033.aspx
...
(:~
 ...
 : @see     http://office.microsoft.com/en-us/excel/HP052090931033.aspx
 : @param   $number is the number
 : @param   $decimals is the number of digits to the right of the decimal point. If decimals is negative, number is rounded to the left of the decimal point
 :) 
declare function excel-text:dollar
  ( $number as xs:decimal,
    $decimals as xs:decimal)  as xs:string {
...
(:~
 : Locate one text string within a second text string, and return the number of the starting position 
 : of the first text string from the first character of the second text string. The search starts at position 1, and it is not case sensitive.
 :
...
(:~
 : Locate one text string within a second text string, and return the number of the starting position 
 : of the first text string from the first character of the second text string. The search starts at $start_num, and it is not case sensitive.
 :
 : @see     http://office.microsoft.com/en-us/excel/HP052092491033.aspx
 : @param   $find_text text you want to find
 : @param   $within_text text in which you want to search for $find_text.
...
(:~
 ...
 : specific text in a text string; use REPLACE when you want to replace any text that occurs in 
 : a specific location in a text string.
 :
