...
#ifndef ZORBA_SERIALIZEMODULE_SERIALIZEMODULE_H
#define ZORBA_SERIALIZEMODULE_SERIALIZEMODULE_H
...
namespace zorba { namespace serializemodule {
  ...
  class SerializeModule : public ExternalModule
  {
    private:
...
#endif /* ZORBA_SERIALIZEMODULE_SERIALIZEMODULE_H */
