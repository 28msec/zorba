...
(:~
 ...
 : nodes given their identifier. The identifiers are stable, i.e. the 
 : corresponding nodes can be retrieved at any time during their lifetime.
 :
...
(:~
 ...
 :
 : @error zerr::ZAPI0090 if the given identifier is not a valid identifier
