 ...
 *
 *  $Id: primitive_update.h,v 1.1 2006/10/09 07:07:59 Paul Pedersen Exp $
 *
...
#ifndef XQP_PRIMITIVE_UPDATE_H
#define XQP_PRIMITIVE_UPDATE_H
...
|_______________________________________________________________________*/
class upd_insert_before : public primitive_update
{
protected:
	node target;
...
|	processing instruction, and comment nodes. 
|_______________________________________________________________________*/
class upd_insert_after : public primitive_update
{
protected:
	node target;
	std::vector<node> content;
...
|	processing instruction, and comment nodes. 
|_______________________________________________________________________*/
class upd_insert_into : public primitive_update
{
protected:
	node target;
	std::vector<node> content;
...
|	processing instruction, and comment nodes. 
|_______________________________________________________________________*/
class upd_insert_into_as_first : public primitive_update
{
protected:
	node target;
	std::vector<node> content;
...
|	processing instruction, and comment nodes. 
|_______________________________________________________________________*/
class upd_insert_into_as_last : public primitive_update
{
protected:
	node target;
	std::vector<node> content;
...
|_______________________________________________________________________*/
class upd_insert_attributes : public primitive_update
{
protected:
	element_node target;
...
|	upd:delete
|_______________________________________________________________________*/
class upd_delete : public primitive_update
{
protected:
	node target;
...
|_______________________________________________________________________*/
class upd_replace_node : public primitive_update
{
protected:
	node target;
	std::vector<node> content;
...
|	instruction node.
|_______________________________________________________________________*/
class upd_replace_value : public primitive_update
{
protected:
	node target;
	std::string content;
...
|_______________________________________________________________________*/
class upd_replace_element_content : public primitive_update
{
protected:
	node target;
	text_node content;
...
|	upd:rename
|_______________________________________________________________________*/
class upd_rename : public primitive_update
{
public:
	upd_rename(
		context& ctx,
