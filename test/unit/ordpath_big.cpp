...
int ordpath_big (int argc, char* argv[])
{
  ...
  zorba::simplestore::OrdPath lOrdPath1((const unsigned char*) lOrdStr1.c_str(), lOrdStr1.length());
  zorba::simplestore::OrdPath lOrdPath2((const unsigned char*) lOrdStr2.c_str(), lOrdStr2.length());
