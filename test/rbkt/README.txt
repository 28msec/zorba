 ...
 -------------------
       ...
       ---------------------------------------------------------
       |            |                         |                |
     Scripts      Queries                 ExpResults         Results
       |            |                         |                |
     rbkt.sh        |                         |         ----------------   
   functions.sh     |                         |         |              |
                    |                         |      <bucket1> ... <bucketN>
 ...
 - The ExpResults directory contains the expected results of each query.
 ...
 - The Results directory contains the actual query results generated by each
   invocation of rbkt.sh.

 - The Results directory (and its subdirs) is generated automatically by rbkt.sh,
   if it doesn't exist already. Result is NOT in svn.
 ...
 compares it (via diff) with file  ExpResults/foo/q.res. The result of this
 diff is writen to Results/foo/q.diff.

 If Results/foo/q.diff is not empty, rbkt.sh reports that Q has failed.
