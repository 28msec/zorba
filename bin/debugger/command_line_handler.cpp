...
template<>
void
CommandLineHandler::handle<BreakpointSet>(std::tr1::tuple<bstring, bstring, bint> &t)
{
...
template<>
void
CommandLineHandler::handle<BreakpointList>(tuple<> &t)
{
...
template<>
void
CommandLineHandler::handle<StackDepth>(tuple<> &t)
{
